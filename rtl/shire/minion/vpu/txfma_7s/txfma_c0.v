...
vpu_ctrl_sigs_t                 sigs_qual_exa_h;
...
`RST_FF (clock, reset,                    ctrl_valid_f0a_h,         ctrl_valid_exa_h,         1'b0)
`EN_FF  (clock,        in_valid_exa_h,    use_prev_sigs_f0a_h,      use_prev_sigs_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  use_mul_op_f0a_h,         use_mul_rfa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  sin_res_shf_idx_f0a_h,    sin_res_shf_idx_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  mul_sign_f0a_h,           mul_sign_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  mul_hp_mode_f0a_h,        mul_hp_mode_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  rm_f0a_h,                 rm_exa_h) 
`EN_FF  (clock,        c0_ctrl_en_exa_h,  op_dtype_f0a_h,           op_dtype_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  cmd_f0a_h,                cmd_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  sigs_f0a_h,               sigs_exa_h)
`EN_FF  (clock,        c0_ctrl_en_exa_h,  trans_exp_fma2_exc_f0a_h, trans_exp_fma2_exc_exa_h) 
