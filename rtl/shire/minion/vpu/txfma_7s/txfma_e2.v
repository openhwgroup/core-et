...
always_comb begin
  case(align1_mux_sel_f2a_h)
    ...
    `TXFMA_SEL_C:                 etrz_1_f2a_h = {($size(etrz_1_f2a_h) - $size(etrz_fc_f2a_h))'(0), etrz_fc_f2a_h};
...
always_comb begin
  case(align2_mux_sel_f2a_h)
    ...
    `TXFMA_SEL_C:                 etrz_2_f2a_h = {($size(etrz_2_f2a_h) - $size(etrz_fc_f2a_h))'(0), etrz_fc_f2a_h};
...
always_comb begin
  case(res_exp_hi_sel_f2a_h)
    ...
    default:                                  exp_res_f2a_h = `TXFMA_EXP_SEXT_PS_SZ'h0;
  endcase
end
