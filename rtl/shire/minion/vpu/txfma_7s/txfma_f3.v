...
///////////////////////////////////////////////////////////////////////////////
 ...
 //    CLK               DOUT                           DIN
  `FF (ctrl_f3_clk, comb_s_f4a_h,                  comb_s_f3a_h            )
  `FF (ctrl_f3_clk, comb_c_f4a_h,                  comb_c_f3a_h            )
  `FF (ctrl_f3_clk, int_minmax_res_f4a_h,          int_minmax_res_f3a_h    )

// Locally flopped control signals I/P from txfma_c2/txfma_e2
  `FF (ctrl_f2_clk, exp_res_f3a_h,                 exp_res_f2a_h                 )
  `FF (ctrl_f2_clk, ediff_abs_diff_hi_f3a_h,       ediff_abs_diff_hi_f2a_h       )
  `FF (ctrl_f2_clk, align2_rshamt_c3_f3a_h,        align2_rshamt_c3_f2a_h        )
  `FF (ctrl_f2_clk, op3p3spc_sel_f3a_h,            op3p3spc_sel_f2a_h            )
  `FF (ctrl_f2_clk, op3p2c_sel_f3a_h,              op3p2c_sel_f2a_h              )
  `FF (ctrl_f2_clk, op3p1c_sel_p_f3a_h,            op3p1c_sel_p_f2a_h            )
  `FF (ctrl_f2_clk, op3p1c_sel_r_f3a_h,            op3p1c_sel_r_f2a_h            )
  `FF (ctrl_f2_clk, op3g_sel_f3a_h,                op3g_sel_f2a_h                )
  `FF (ctrl_f2_clk, ugfxrplc_sel_f3a_h,            ugfxrplc_sel_f2a_h            )
  `FF (ctrl_f2_clk, sgfxrplc_sel_f3a_h,            sgfxrplc_sel_f2a_h            )
  `FF (ctrl_f2_clk, icgfxc_sel_f3a_h,              icgfxc_sel_f2a_h              )
  `FF (ctrl_f2_clk, al1p1c_sel_f3a_h,              al1p1c_sel_f2a_h              )
  `FF (ctrl_f2_clk, al1p2c_sel_f3a_h,              al1p2c_sel_f2a_h              )
  `FF (ctrl_f2_clk, rm_rne_f3a_h,                  rm_rne_f2a_h                  )
  `FF (ctrl_f2_clk, rm_rmm_f3a_h,                  rm_rmm_f2a_h                  )
  `FF (ctrl_f2_clk, frnd_rupnsc_f3a_h,             frnd_rupnsc_f2a_h             )
  `FF (ctrl_f2_clk, frnd_rdnsc_f3a_h,              frnd_rdnsc_f2a_h              )
  `FF (ctrl_f2_clk, frnd_t1_f3a_h,                 frnd_t1_f2a_h                 )
  `FF (ctrl_f2_clk, frnd_t2_f3a_h,                 frnd_t2_f2a_h                 )
  `FF (ctrl_f2_clk, al1znp2c_sel_f3a_h,            al1znp2c_sel_f2a_h            )
  `FF (ctrl_f2_clk, al1c_zap_f3a_h,                al1c_zap_f2a_h                )
  `FF (ctrl_f2_clk, op1c_log_mul_clr_f3a_h,        op1c_log_mul_clr_f2a_h        )
  `FF (ctrl_f2_clk, negop1c_int_logmul_clr_f3a_h,  negop1c_int_logmul_clr_f2a_h  )
  `FF (ctrl_f2_clk, psc_op1_clr_f3a_h,             psc_op1_clr_f2a_h             )
  `FF (ctrl_f2_clk, al2c_sel_f3a_h,                al2c_sel_f2a_h                )
  `FF (ctrl_f2_clk, align2_zap_f3a_h,              align2_zap_f2a_h              )
  `FF (ctrl_f2_clk, align2c_neg_f3a_h,             align2c_neg_f2a_h             )
  `FF (ctrl_f2_clk, op2_sxtto_g_f3a_h,             op2_sxtto_g_f2a_h             )
...
align_shf_48
(
  .op       ( {align_in_48b_f3a_h, 2'b0}  ),
  .shfamnt  ( ediff_abs_diff_hi_f3a_h     ),
  .op_align ( aligned_48b_f3a_h           )
);
...
align_shf_27
(
  .op       ( {align_in_25b_f3a_h, 2'b0}),
  .shfamnt  ( align2_rshamt_c3_f3a_h   ),
  .op_align ( aligned_25b_f3a_h        )
);
...
// Bits [B25:B29]
assign opd3_f3a_h[`TXFMA_B25:`TXFMA_B29] = opd3_prod_f3a_h[`TXFMA_B25:`TXFMA_B29] & {($bits(opd3_prod_f3a_h[`TXFMA_B25:`TXFMA_B29])){op3p1c_sel_p_f3a_h}}; 

// Bits [B30]
assign opd3_f3a_h[`TXFMA_B30] = (opd3_prod_f3a_h[`TXFMA_B30] & op3p1c_sel_p_f3a_h) | (fround_l_f3a_h & op3p1c_sel_r_f3a_h); 

// Bits [B31]
assign opd3_f3a_h[`TXFMA_B31] = (opd3_prod_f3a_h[`TXFMA_B31] & op3p1c_sel_p_f3a_h);

// Bits [B32:B47]
assign opd3_f3a_h[`TXFMA_B32:`TXFMA_B47] = opd3_prod_f3a_h[`TXFMA_B32:`TXFMA_B47] & {($bits(opd3_prod_f3a_h[`TXFMA_B32:`TXFMA_B47])){op3p1c_sel_p_f3a_h}}; 
