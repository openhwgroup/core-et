...
always_comb begin
  ...
  eb_hi_mux_f1a_h = (cmd_f1a_h==`VPU_TRANS_RCP_FMA2)      ? {2'h3,~eb_hi_f1a_h}
                  ...
                  : (cmd_f1a_h==`VPU_TRANS_EXP_FMA2)      ? `SX(`TXFMA_EXP_SEXT_PS_SZ,eb_hi_f1a_h)
  ...
  ec_mux_f1a_h = (op_dtype_f1a_h == `VPU_DTYPE_F32 || 
                  op_dtype_f1a_h == `VPU_DTYPE_F16_F32) ? ec_f1a_h  
                    :   (ec_zero_f1a_h)                ? `TXFMA_EXP_PS_SZ'h0                      //  5 bit exponent equals 0
                    :   (ec_all1_f1a_h)                 ?   `TXFMA_EXP_PS_SZ'hFF                   // if input is all 1's, map it to all 1's
...
assign cin_hi_mux_f1a_h = cin_hi_bias_sel_f1a_h ? {2'h0, `FLOAT32_E_BIAS_HEX}
                        : cin_hi_zero_sel_f1a_h ? `TXFMA_EXP_SEXT_PS_SZ'h0
