...
begin
  ...
  //adder in mux
assign e_res_adder_in2_mux_f6a_h = (cmd_f6a_h==`VPU_TRANS_RSQRT_FMA2) ? `TXFMA_EXP_PS_SZ'hfe //substract 2 to compensate cin 
                                    :                                   `TXFMA_EXP_PS_SZ'b0;
...
exp_hi_res_adder_hi
(
  .a    ( exp_res_in_f6a_h[`TXFMA_EXP_PS_SZ-1:0] ),
  .b    ( e_res_adder_in2_mux_f6a_h              ),
  .cin  ( 1'b1                                   ),
  .sum  ( exp_res_inc_dec_f6a_h                  ) 
);
