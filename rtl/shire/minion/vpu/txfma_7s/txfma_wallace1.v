...
// NOTE: since ps/int32 are treated the same we can combine them and use ~hp_mode
assign ph       = mode; 
assign ps_int32 = ~mode; 

assign pp1_ext={31'b0, pp1} | {{(`TXFMA_A3-34){1'b0}}, ps_int32, 33'b0} | {{(`TXFMA_A3-14){1'b0}}, ph, 13'b0}; // magic '1'
