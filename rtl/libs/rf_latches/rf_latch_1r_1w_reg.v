...
//-----------------------------------------------------------------------------
// Title         : Latch based Register Files with registered read output
// Project       : ??
//-----------------------------------------------------------------------------
// File          : rf_latch_1r_1w_reg.v
// Author        : 
// Created       : 09.04.2018
...
module rf_latch_1r_1w_reg (/*AUTOARG*/
   // Outputs
   rd_data_a,
   // Inputs
   rd_addr_a, rd_en_a,
   ...
   /*
    ...
    2) The read data are flopped before producing a combinatorial output in the 
   ...
   input              rd_en_a;   // Read Enable port A
...
`endif
   ...
   assign rd_data_a = rf[rd_addr_a_reg];
