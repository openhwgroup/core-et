...
// Grant is provided even if stall signal is asserted
module arb_lru_grant
#(
...
`ASSERT_ALWAYS(ERROR_ARB_LRU_GRANT_grant_one_hot_zero,    clock, reset, $onehot0(grant) )
