...
//
// Technology primitive: latch-timed 3R2W register file. ECP5 implementation
// using one distributed storage replica per read port and write bank.

module prim_rf_3r2w #(
  parameter int unsigned Width        = 32,
  parameter int unsigned Entries      = 32,
  /* verilator lint_off UNUSEDPARAM */  // retained for ASIC compatibility, unused by the ECP5 body
