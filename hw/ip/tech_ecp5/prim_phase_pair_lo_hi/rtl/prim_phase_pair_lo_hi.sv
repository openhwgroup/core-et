...
//
// Direct low-phase to high-phase two-stage capture pair.
//
// Preserve the original low-phase latch followed by high-phase latch
...
module prim_phase_pair_lo_hi #(
  ...
  /* verilator lint_off NOLATCH */  // This primitive intentionally models the direct low-phase to high-phase transparent handoff.
  always_latch begin
    if (clk_i) begin
      lo_en_2p <= lo_en_i;
    end
