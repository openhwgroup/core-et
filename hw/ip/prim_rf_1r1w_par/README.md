...
Latch-timed 1R1W register-file primitive with parallel readback.

This IP currently provides:

| Module | Selected by | Implementations |
|--------|-------------|-----------------|
| `prim_rf_1r1w_par` | `mk/prim.mk` via `PRIM_RF_1R1W_PAR` | `tech_generic/prim_rf_1r1w_par` |

The implementation preserves the original `rf_latch_1r_1w_par` timing:
