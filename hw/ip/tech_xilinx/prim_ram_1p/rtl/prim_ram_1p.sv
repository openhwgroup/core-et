...
//
// Single-port RAM wrapper — Xilinx FPGA implementation.
//
// Forces block RAM inference via ram_style attribute, avoiding
// Yosys LUTRAM mapping issues with unusual width/depth combinations.
