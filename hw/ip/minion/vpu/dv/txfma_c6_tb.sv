...
module txfma_c6_tb import vpu_defs_pkg::*;
(
  ...
  output logic sel_gmaxu24_f6a_h,
  output logic sel_gmaxu16_f6a_h,
  output logic sel_gmaxs16_f6a_h,
  output logic sel_gmins16_f6a_h,
  output logic sel_gmaxs8_f6a_h,
  output logic sel_gmaxu2_f6a_h,
  output logic sel_gmins8_f6a_h,
  output logic sel_gmaxu8_f6a_h,
  output logic sel_gfxmax_f6a_h,
  output logic sel_psexc_sr_f6a_h,
  output logic sel_bit31_one_f6a_h,
  output logic sel_b30to0_ones_f6a_h,
  output logic sel_zerores_f6a_h,
  output logic sel_ps_unf_f6a_h,
  output logic sel_ps_normone_f6a_h,
  output logic sel_ps_inf_f6a_h,
  output logic sel_ps_cqn_f6a_h,
  output logic sel_ps_large_f6a_h,
  output logic sel_phsp_f6a_h,
  output logic sel_phhi_sr_f6a_h,
  output logic sel_phhi_large_f6a_h,
  output logic sel_phhi_unf_f6a_h,
  output logic sel_phhi_infres_f6a_h,
  output logic sel_f11large_f6a_h,
  output logic sel_f10large_f6a_h,
  output logic sel_f11inf_f6a_h,
  output logic sel_f10cqnan_f6a_h,
  output logic sel_f11sp_f6a_h,
  output logic sel_f10sp_f6a_h,
  output logic ps_rndovf_f6a_h,
  output logic ph_rndovf_f6a_h,
  output logic sel_set_bit0_one_f6a_h,
  output logic effsub1_set_sign1_f6a_h,
  output logic normmask1_f6a_h,
  output logic normmask2_f6a_h,
  output logic sel_classify_out_f6a_h,
  output logic sel_nr1_frcpres_f6a_h,
  output logic trans_sinp2m_f6a_h,
  output logic f10f11mux_sel_f6a_h,
  output logic rrmux16l_sel_f6a_l,
  output logic [1:0] rrmux32_sel_f6a_h,
  output logic [1:0] sel_excreshi_f6a_h,
  output logic [1:0] sel_excreslo_f6a_h,
  output logic [1:0] sel_fmares_hi_f6a_h,
  output logic [1:0] sel_fmares_lo_f6a_h,
  output logic [VPU_FLAGS_SZ-1:0] fma_flags_f6a_h,
  ...
  assign all_outputs = {
    ...
    sel_psexc_sr_f6a_h,
    sel_bit31_one_f6a_h,
    sel_b30to0_ones_f6a_h,
    sel_zerores_f6a_h,
    sel_ps_unf_f6a_h,
    sel_ps_normone_f6a_h,
    sel_ps_inf_f6a_h,
    sel_ps_cqn_f6a_h,
    sel_ps_large_f6a_h,
    sel_phsp_f6a_h,
    sel_phhi_sr_f6a_h,
    sel_phhi_large_f6a_h,
    sel_phhi_unf_f6a_h,
    sel_phhi_infres_f6a_h,
    sel_f11large_f6a_h,
    sel_f10large_f6a_h,
    sel_f11inf_f6a_h,
    sel_f10cqnan_f6a_h,
    ...
    ps_rndovf_f6a_h,
    ph_rndovf_f6a_h,
    sel_set_bit0_one_f6a_h,
    effsub1_set_sign1_f6a_h,
    normmask1_f6a_h,
    normmask2_f6a_h,
    sel_classify_out_f6a_h,
    sel_nr1_frcpres_f6a_h,
    trans_sinp2m_f6a_h,
    f10f11mux_sel_f6a_h,
    rrmux16l_sel_f6a_l,
    rrmux32_sel_f6a_h,
