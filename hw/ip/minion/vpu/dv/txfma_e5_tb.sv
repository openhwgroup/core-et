...
(
  ...
  output logic                                    stky2g_o,
  output logic                                    rmode_o,
  output logic [TXFMA_EXP_SEXT_PS_SZ-1:0]        exp_res_o
);
  ...
  txfma_e5 u_dut (
    ...
    .stky2g_f5a_h               (stky2g_o),
    .rmode_f5a_h                (rmode_o),
    .exp_res_f5a_h              (exp_res_o)
  );

endmodule : txfma_e5_tb
