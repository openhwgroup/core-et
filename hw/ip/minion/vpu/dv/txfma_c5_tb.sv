...
module txfma_c5_tb import vpu_defs_pkg::*;
(
  ...
  output logic rc6_ps_f5a_h,
  output logic rc6_ph_f5a_h,
  output logic rc_int32_f5a_h,
  output logic rc_3rmxr_f5a_h,
  output logic rc_rl01_f5a_h,
  output logic rc_rmm_f5a_h,
  output logic rc_rup_f5a_h,
  output logic rc_rne_f5a_h,
  output logic rc_rdn_f5a_h,
  output logic rc_res_sign_f5a_l,
  output logic rc_transrnd_f5a_h,
  output logic rc_transrnd_log_fma2_f5a_h,
  output logic nshcen_sel1b_f5a_h,
  output logic en_logrrsel1b_f5a_l,
  output logic int32_stky2r_f5a_h,
  output logic mmx_sel_immres_f5a_h,
  output logic comp_op_true_f5a_h,
  output logic trans2_ps_roundup_r_f5a_h,
  ...
  assign all_outputs = {
    ...
    rc_res_sign_f5a_l,
    rc_transrnd_f5a_h,
    rc_transrnd_log_fma2_f5a_h,
    nshcen_sel1b_f5a_h,
    en_logrrsel1b_f5a_l,
    int32_stky2r_f5a_h,
    mmx_sel_immres_f5a_h,
    comp_op_true_f5a_h,
    trans2_ps_roundup_r_f5a_h,
    e_force_to_zero_f5a_h,
    s_res_out_f5a_h
  };

  assign out_chunk0_o = {{ 42{1'b0} }, all_outputs[21:0]};

endmodule : txfma_c5_tb
