...
/* verilator lint_off WIDTHEXPAND */  // Imported original TensorReduce arithmetic mixes narrow counters with macro-sized constants.
/* verilator lint_off WIDTHTRUNC */  // The preserved original counter updates intentionally truncate back into packed reduce-control fields.
...
(
    ...
    input  minion_pkg::reduce_tensorstore_control_t reduce_ctrl,
    ...
    output logic [INST_SIZE-1:0]        reduce_inst_next,
    //debug
...
always_ff @(posedge clock) begin
    ...
    if (new_req) begin
        ...
        cols_per_row <= reduce_ctrl.tensorstore.cols;
    end
...
begin
    ...
    begin
        ...
        if(reg_pending_next[2:0] == 3'b000)
        begin
    ...
    if(new_req && (reg_pending_next!=7'b0))
    begin
...
begin
    ...
    // Exec case
    if(exec_op_s0 && (reduce_op == 4'b0000))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b0010))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b0011))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b0100))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b0110))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b0111))
    begin
    ...
    else if(exec_op_s0 && (reduce_op == 4'b1000))
    begin
