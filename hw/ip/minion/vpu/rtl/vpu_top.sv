...
/* verilator lint_off SYNCASYNCNET */  // Imported original VPU top preserves mixed async-reset/sync-enable macro structure across the TXFMA pipeline.
/* verilator lint_off UNUSEDSIGNAL */  // Wide packed VPU result/debug buses intentionally leave some bits unused in this top-level slice.
module vpu_top
#(
...
logic                                                  f8_thread_id;
logic [FREG_ADDR_SIZE-1:0]                               f8_regfile_waddr;
logic [VPU_DATA_SZ-1:0]                                f8_wdata;
...
generate for (genvar i = 0; i < VPU_LANE_NUM; i++)
begin: F3_REGMASK_WDATA_LANE
...
(
  ...
  .f3_regfile_wen_l            ( f3_regfile_wen_l                       ),
...
begin : VPU_LANES
    ...
    (
        ...
        .f2_tima_ren3                ( f2_tima_ren3                                              ),
        .f2_tima_tenc_raddr          ( f2_tima_tenc_raddr                                        ),
        .f2_tima_tenc_wen            ( f2_tima_tenc_wen[i]                                       ),
        .f2_tima_rf_wen              ( f2_tima_rf_wen[i]                                         ),
        .f2_tenb_regfile_wen_l       ( f2_tenb_regfile_wen_l                                     ),
        ...
        .f7_regfile_waddr            ( f7_regfile_waddr                                          ),
        .f7_bypass_clk_en            ( f7_bypass_clk_en                                          ),
        .f7_regfile_wen              ( f7_regfile_wen[i]                                         ),
        // F8 inputs
        .f8_thread_id                ( f8_thread_id                                              ),
