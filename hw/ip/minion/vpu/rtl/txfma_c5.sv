...
/* verilator lint_off WIDTHEXPAND */  // Imported original TXFMA compare/exponent helpers use macro-sized literals against narrow packed fields.
/* verilator lint_off UNUSEDSIGNAL */  // Packed control buses intentionally retain unused bits in this imported stage.
module txfma_c5
(
