...
/* verilator lint_off WIDTHTRUNC */  // Imported original TXFMA normalization helpers intentionally truncate wider constant arithmetic into packed shift fields.
/* verilator lint_off CASEINCOMPLETE */  // Sparse decode cases are preserved from the original control logic.
/* verilator lint_off UNUSEDSIGNAL */  // Packed control buses keep their original shape even when this stage consumes only a subset of bits.
module txfma_c4
(
...
always_comb begin
  ...
  norm_shftamt_f4a_h        = 7'b0;
  tmp_norm_shftamt_f4a_h    = 7'b0;
    ...
    VPU_DTYPE_INT: begin
      ...
      if (cmd_f4a_h==VPU_TRANS_SIN_P1 || cmd_f4a_h==VPU_TRANS_SIN_P2) begin
        case (sin_res_shf_idx_f4a_h)
          3'd0: tmp_norm_shftamt_f4a_h = 7'h7e;
