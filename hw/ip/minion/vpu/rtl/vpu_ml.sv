...
(
    ...
    output logic [INST_SIZE-1:0]                           id_inst_next,
    output logic [VPU_LANE_NUM-1:0]                     id_mask_next,
    output logic                                         id_inst_en,
    input  logic [INST_SIZE-1:0]                           id_inst,
...
logic [INST_SIZE-1:0] reduce_inst_next;    // Reduce generated instruction for next cycle
...
begin
    ...
    if(!tensorfma_dcache_ctrl.scp_req.read_en && tensorquant_scp_req.read_en)
