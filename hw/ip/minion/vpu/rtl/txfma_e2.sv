...
/* verilator lint_off WIDTHEXPAND */  // Imported original TXFMA exponent-select stage uses macro-sized constants and packed-field promotion.
/* verilator lint_off WIDTHTRUNC */  // The preserved original stage intentionally truncates wider helper expressions into packed exponent slices.
/* verilator lint_off UNOPTFLAT */  // Result-exponent selection feeds the preserved original operand-order helper; Verilator flattens a false loop here.
/* verilator lint_off UNUSEDSIGNAL */  // Helper CSA/carry signals keep the original structure even when some packed bits are not consumed downstream.
module txfma_e2
(
  ...
  input  [4:0]                                etrz_fa_lo_ps_f2a_h,
  input  [4:0]                                etrz_fc_f2a_h,
  ...
  output                                      ediff1_zap_f2a_h,
  output       [5:0]                          ediff_abs_diff_hi_f2a_h,
  output       [4:0]                          align2_rshamt_c3_f2a_h,
  output logic [6:0]                          exp_res_2f3_f2a_h,
  output       [TXFMA_EDIFF_OPD_SEL_SZ-1:0]  align1_mux_sel_f2a_h,
  output       [TXFMA_EDIFF_OPD_SEL_SZ-1:0]  align2_mux_sel_f2a_h,
  output       [TXFMA_EDIFF_OPD_SEL_SZ-1:0]  opd3_mux_sel_f2a_h,
  output       [TXFMA_EXP_SEXT_PS_SZ-1:0]    ediff1_f2a_h,
  output       [TXFMA_EXP_SEXT_PS_SZ-1:0]    ediff2_f2a_h,
  output       [TXFMA_EDIFF_OPD_SEL_SZ-1:0]  ediff1_sel_f2a_h,
  output       [TXFMA_EDIFF_OPD_SEL_SZ-1:0]  ediff2_sel_f2a_h,
  output       [TXFMA_EXP_SEXT_PS_SZ-1:0]    ediff1_abs_f2a_h,
  output       [TXFMA_EXP_SEXT_PS_SZ-1:0]    ediff2_abs_f2a_h,
  output logic [TXFMA_EXP_SEXT_PS_SZ-1:0]    exp_res_f2a_h
);
...
logic [TXFMA_EXP_SEXT_PS_SZ-1:0]   exp_frac_e_shift_f2a_h;
logic [TXFMA_EXP_SEXT_PS_SZ-1:0]   ediff1_abs_int_f2a_h;
logic [TXFMA_EXP_SEXT_PS_SZ-1:0]   ediff2_abs_int_f2a_h;
...
always_comb begin
  case(ediff1_sel_f2a_h)
    ...
    TXFMA_SEL_EDIFF_ZERO:                               ediff1_mux_f2a_h = 10'h0;
    TXFMA_SEL_EDIFF_LOG_MUL:                            ediff1_mux_f2a_h = 10'h7;
    TXFMA_SEL_EDIFF_LOG_MUL2:                           ediff1_mux_f2a_h = 10'h0;
    TXFMA_SEL_EDIFF_NR2_FRCPFXP:                        ediff1_mux_f2a_h = 10'h0;
    default:                                            ediff1_mux_f2a_h = 10'h0;
  endcase
end
...
assign ediff_gt_31_f2a_h = $signed(ediff1_mux_f2a_h) > 31;
...
assign ediff1_f2a_h         = ediff1_zap_f2a_h ? 10'h0 : ediff1_mux_f2a_h;
assign ediff1_abs_int_f2a_h = ediff1_f2a_h[TXFMA_EXP_SEXT_PS_SZ-1] ? -ediff1_f2a_h : ediff1_f2a_h;
...
always_comb begin
  case(ediff2_sel_f2a_h)
    ...
    default:                                               ediff2_mux_f2a_h = 10'h0;
  endcase
end

assign ediff2_f2a_h         = ediff2_mux_f2a_h;
assign ediff2_abs_int_f2a_h = ediff2_mux_f2a_h[TXFMA_EXP_SEXT_PS_SZ-1] ? -ediff2_mux_f2a_h : ediff2_mux_f2a_h;
...
always_comb begin
  case(align1_mux_sel_f2a_h)
    TXFMA_SEL_PH:               etrz_1_f2a_h = {{($bits(etrz_1_f2a_h) - $bits(etrz_prod_hi_ph_f2a_h)){1'b0}}, etrz_prod_hi_ph_f2a_h};
    TXFMA_SEL_P, TXFMA_SEL_PL:  etrz_1_f2a_h = {{($bits(etrz_1_f2a_h) - $bits(etrz_prod_lo_ps_f2a_h)){1'b0}}, etrz_prod_lo_ps_f2a_h};
    TXFMA_SEL_C:                etrz_1_f2a_h = {{($bits(etrz_1_f2a_h) - $bits(etrz_fc_f2a_h)){1'b0}}, etrz_fc_f2a_h};
    TXFMA_SEL_A:                etrz_1_f2a_h = {{($bits(etrz_1_f2a_h) - $bits(etrz_fa_lo_ps_f2a_h)){1'b0}}, etrz_fa_lo_ps_f2a_h};
    default:                    etrz_1_f2a_h = 5'h0;
  endcase
end
...
always_comb begin
  case(align2_mux_sel_f2a_h)
    TXFMA_SEL_PH:               etrz_2_f2a_h = {{($bits(etrz_2_f2a_h) - $bits(etrz_prod_hi_ph_f2a_h)){1'b0}}, etrz_prod_hi_ph_f2a_h};
    TXFMA_SEL_P, TXFMA_SEL_PL:  etrz_2_f2a_h = {{($bits(etrz_2_f2a_h) - $bits(etrz_prod_lo_ps_f2a_h)){1'b0}}, etrz_prod_lo_ps_f2a_h};
    TXFMA_SEL_C:                etrz_2_f2a_h = {{($bits(etrz_2_f2a_h) - $bits(etrz_fc_f2a_h)){1'b0}}, etrz_fc_f2a_h};
    TXFMA_SEL_A:                etrz_2_f2a_h = {{($bits(etrz_2_f2a_h) - $bits(etrz_prod_hi_ph_f2a_h)){1'b0}}, etrz_prod_hi_ph_f2a_h};
    default:                    etrz_2_f2a_h = 5'h0;
  endcase
end
...
always_comb begin
  ...
  case (op_dtype_f2a_h)
    VPU_DTYPE_INT:               e_1_tk_f2a_h = {5'b0,$unsigned(TXFMA_F32_A_C_STICKY_DISTANCE)};

    VPU_DTYPE_F32:
                                  if ((align1_mux_sel_f2a_h==TXFMA_SEL_P) & ~sigs_f2a_h[TXFMA_NORM_F32])
                                    e_1_tk_f2a_h = {8'b0,$unsigned(TXFMA_F32_PROD_STICKY_DISTANCE)};
                                  else
  ...
  if (cmd_f2a_h==VPU_FCMD_FROUND)
    e_1_tk_f2a_h = {6'b0,$unsigned(TXFMA_INT_STICKY_DISTANCE)};
end
...
(
 .a_i  ( e_1_tk_f2a_h                ),
 .b_i  ( ~ediff1_abs_int_f2a_h       ),
 .cin_i( etrz_1_f2a_h                ),
 .cout_o( exp_sticky1_csa_carry_f2a_h ),
 .sum_o( exp_sticky1_csa_sum_f2a_h   )
);
...
///////////////////////////////////////////////////////////////////////////////
assign exp_sticky2_csa_inb_mux_f2a_h = (cmd_f2a_h==VPU_TRANS_EXP_FRAC) ? ~{2'b0,ec_f2a_h}
                                     :                                    ~ediff2_abs_int_f2a_h;
assign exp_sticky2_csa_cin_mux_f2a_h = (cmd_f2a_h==VPU_TRANS_EXP_FRAC) ? 10'b0
                                     :                                    etrz_2_f2a_h;
...
(
 .a_i  ( e_2_tk_f2a_h                  ),
 .b_i  ( exp_sticky2_csa_inb_mux_f2a_h ),
 .cin_i( exp_sticky2_csa_cin_mux_f2a_h ),
 .cout_o( exp_sticky2_csa_carry_f2a_h   ),
 .sum_o( exp_sticky2_csa_sum_f2a_h     )
);
...
exp_sticky1_adder
(
  .a_i  ( exp_sticky1_csa_sum_f2a_h                                      ),
  .b_i  ( {exp_sticky1_csa_carry_f2a_h[TXFMA_EXP_SEXT_PS_SZ-2:0], 1'b0} ),
  .cin_i( 1'b1                                                           ),
  .sum_o( e_sticky1_add_f2a_h                                            )
);
...
exp_sticky2_adder
(
  .a_i  ( exp_sticky2_csa_sum_f2a_h                                      ),
  .b_i  ( {exp_sticky2_csa_carry_f2a_h[TXFMA_EXP_SEXT_PS_SZ-2:0], 1'b0} ),
  .cin_i( 1'b1                                                           ),
  .sum_o( e_sticky2_add_f2a_h                                            )
);
...
always_comb begin
  case(res_exp_hi_sel_f2a_h)
    TXFMA_SEL_PH,TXFMA_SEL_P,TXFMA_SEL_A:  exp_res_f2a_h = eprod_hi_f2a_h;
    TXFMA_SEL_PL:                            exp_res_f2a_h = eprod_lo_f2a_h;
    TXFMA_SEL_C:                             exp_res_f2a_h = {2'b0,ec_f2a_h};
    TXFMA_SEL_B:                             exp_res_f2a_h = {2'b0,eb_hi_f2a_h};
    TXFMA_SEL_CVT_F32INT:                    exp_res_f2a_h = (FLOAT32_E_BIAS_HEX+TXFMA_CVT_F32INT_OFFSET);
    TXFMA_SEL_CVT_F32_FXP1615:               exp_res_f2a_h = (FLOAT32_E_BIAS_HEX+TXFMA_CVT_F32_FXP1615_OFFSET);
    TXFMA_SEL_GCVT_F32_NORM:                 exp_res_f2a_h = (FLOAT32_E_BIAS_HEX-TXFMA_GCVT_F32_NORM_OFFSET);
    TXFMA_SEL_EXP_FRAC:                      exp_res_f2a_h = (FLOAT32_E_BIAS_HEX+TXFMA_EXP_FRAC_OFFSET);
    default:                                  exp_res_f2a_h = 10'h0;
  endcase
end

// Send lower bits of exp_res_f2a_h to txfma_f2
assign exp_res_2f3_f2a_h = exp_res_f2a_h[6:0];
...
always_comb begin
  case(res_exp_lo_sel_f2a_h)
    ...
    default:             exp_frac_e_shift_f2a_h = 10'h0;
  endcase
end
...
///////////////////////////////////////////////////////////////////////////////
// Determine absolute value of ediff for the alignment shifters
///////////////////////////////////////////////////////////////////////////////
assign ediff1_abs_f2a_h = (cmd_f2a_h==VPU_TRANS_EXP_FRAC) ? exp_frac_e_shift_f2a_h : ediff1_abs_int_f2a_h;
assign ediff2_abs_f2a_h = (cmd_f2a_h==VPU_TRANS_SIN_TRANSFORM) ? {{(TXFMA_EXP_SEXT_PS_SZ-1){1'b0}},sin_ediff2_f2a_h} : ediff2_abs_int_f2a_h;


///////////////////////////////////////////////////////////////////////////////
// Drive the shift amounts to the Alignment Shifters in txfma_f3
// Due to timing constraints, the signals will be flopped within txfma_f3
///////////////////////////////////////////////////////////////////////////////

assign ediff_abs_diff_hi_f2a_h = ediff1_abs_f2a_h[5:0];
assign align2_rshamt_c3_f2a_h  = ediff2_abs_f2a_h[4:0];
