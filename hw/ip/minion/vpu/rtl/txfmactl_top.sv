...
always_ff @(posedge clock) begin
  if (reset) begin
    ctrl_valid_f1a_h <= 1'b0;
  end else begin
    ctrl_valid_f1a_h <= ctrl_valid_f0a_h;
  end

  if (ctrl_valid_f0a_h) begin
    {trans_exp_fma2_exc_f1a_h,
     sin_res_shf_idx_f1a_h,
     flog_mul_prod_zero_f1a_h} <= {trans_exp_fma2_exc_f0a_h,
    ...
    {sa_hi_f1a_h,
     ...
     sb_hi_f1a_h,
     sb_lo_f1a_h,
     sc_f1a_h} <= {sa_hi_f0a_h,
                   sa_lo_f0a_h,
                   sb_hi_f0a_h,
                   sb_lo_f0a_h,
                   sc_f0a_h};

    use_prev_sigs_f1a_h <= use_prev_sigs_f0a_h;
    ...
    {res_inf_f1a_h,
     ...
     res_snorm_one_f1a_h,
     flags_en_f1a_h,
     spec_res_en_f1a_h} <= {res_inf_f0a_h,
                            res_snan_f0a_h,
                            res_qnan_f0a_h,
                            res_zero_f0a_h,
                            res_one_f0a_h,
  ...
  if (ctrl_valid_f0a_h && !use_prev_sigs_f0a_h) begin
    {op_dtype_f1a_h,
     cmd_in_f1a_h,
     sigs_f1a_h,
     rm_f1a_h} <= {op_dtype_f0a_h,
                   cmd_f0a_h,
                   sigs_f0a_h,
                   rm_f0a_h};
  end
...
always_ff @(posedge clock) begin
  if (reset) begin
    ctrl_valid_f2a_h <= 1'b0;
    spec_res_en_f2a_h <= 1'b0;
    flags_en_f2a_h <= 1'b0;
  end else begin
    ctrl_valid_f2a_h <= ctrl_valid_f1a_h;
    if (ctrl_valid_f1a_h) begin
      {spec_res_en_f2a_h,
       flags_en_f2a_h} <= {spec_res_en_f1a_h,
                           flags_en_f1a_h};
    end
  end

  if (ctrl_valid_f1a_h) begin
    sin_res_shf_idx_f2a_h <= sin_res_shf_idx_f1a_h;

    {prod_sign_hi_f2a_h,
     prod_sign_lo_f2a_h,
     sc_f2a_h} <= {prod_sign_hi_f1a_h,
                   prod_sign_lo_f1a_h,
                   sc_f1a_h};

    trans_exp_fma2_exc_f2a_h <= trans_exp_fma2_exc_f1a_h;
    use_prev_sigs_f2a_h <= use_prev_sigs_f1a_h;
    ...
    {ec_zero_f2a_h,
     ...
     sel_fcmask_f2a_h,
     fc_zero30_8_f2a_h,
     fb_hi_zero_f2a_h} <= {ec_zero_f1a_h,
                           eprod_hi_zero_f1a_h,
                           eprod_lo_zero_f1a_h,
                           sel_fcmask_f1a_h,
                           fc_zero30_8_f1a_h,
    ...
    {res_inf_f2a_h,
     ...
     res_uint_nan_f2a_h} <= {res_inf_f1a_h,
                             res_snan_f1a_h,
                             res_qnan_f1a_h,
                             res_zero_f1a_h,
                             res_one_f1a_h,
    ...
    {prod_inf_hi_f2a_h,
     ...
     norm_f32_ovf_f2a_h,
     norm_one_out_f2a_h,
     prod_inf_lo_f2a_h} <= {prod_inf_hi_f1a_h,
                            a_inf_f1a_h,
                            c_inf_f1a_h,
                            a_is_qnan_hi_f1a_h,
                            c_is_qnan_f1a_h,
  ...
  if (ctrl_valid_f1a_h && !use_prev_sigs_f1a_h) begin
    {op_dtype_f2a_h,
     cmd_f2a_h,
     sigs_f2a_h,
     rm_f2a_h,
     minmax_op_f2a_h} <= {op_dtype_f1a_h,
                          cmd_f1a_h,
                          sigs_f1a_h,
                          rm_f1a_h,
                          minmax_op_f1a_h};
  ...
  if (ctrl_valid_f1a_h && flags_en_f1a_h) begin
    flags_f2a_h <= flags_f1a_h;
  end
end
...
always_ff @(posedge clock) begin
  if (reset) begin
    ...
    ctrl_valid_f3a_h <= ctrl_valid_f2a_h;

    if (ctrl_valid_f2a_h) begin
      flags_en_f3a_h <= flags_en_f2a_h;
      spec_res_en_f3a_h <= spec_res_en_f2a_h;
    end
  end

  if (ctrl_valid_f2a_h) begin
    sin_res_shf_idx_f3a_h <= sin_res_shf_idx_f2a_h;
    {eff_sub1_f3a_h, eff_sub2_f3a_h} <= {eff_sub1_f2a_h, eff_sub2_f2a_h};
    {sc_f3a_h, prod_sign_hi_f3a_h, prod_sign_lo_f3a_h, eff_sign1_f3a_h} <=
        {sc_f2a_h, prod_sign_hi_f2a_h, prod_sign_lo_f2a_h, eff_sign1_f2a_h};
    {sin_eff_sub1_f3a_h,
    ...
    use_prev_sigs_f3a_h <= use_prev_sigs_f2a_h;
    {ec_zero_f3a_h, eprod_hi_zero_f3a_h, eprod_lo_zero_f3a_h, fb_hi_zero_f3a_h} <=
        {ec_zero_f2a_h, eprod_hi_zero_f2a_h, eprod_lo_zero_f2a_h, fb_hi_zero_f2a_h};
    {res_inf_f3a_h,
     res_snan_f3a_h,
     res_qnan_f3a_h,
     res_zero_f3a_h,
    ...
    if (!use_prev_sigs_f2a_h) begin
      {op_dtype_f3a_h, cmd_f3a_h, sigs_f3a_h, rm_f3a_h, minmax_op_f3a_h} <=
          {op_dtype_f2a_h, cmd_f2a_h, sigs_f2a_h, rm_f2a_h, minmax_op_f2a_h};
    end

    if (flags_en_f2a_h) begin
      flags_f3a_h <= flags_f2a_h;
    end
  end
end
...
always_ff @(posedge clock) begin
  if (reset) begin
    ...
    ctrl_valid_f4a_h <= ctrl_valid_f3a_h;

    if (ctrl_valid_f3a_h) begin
      flags_en_f4a_h <= flags_en_f3a_h;
      spec_res_en_f4a_h <= spec_res_en_f3a_h;
    end
  end

  if (ctrl_valid_f3a_h) begin
    int_minmax_mux_sel_a_f4a_h <= int_minmax_mux_sel_a_f3a_h;
    int_minmax_mux_sel_c_f4a_h <= int_minmax_mux_sel_c_f3a_h;
    sin_res_shf_idx_f4a_h <= sin_res_shf_idx_f3a_h;
    {eff_sub2_f4a_h, eff_sub1_f4a_h} <= {eff_sub2_f3a_h, eff_sub1_out_f3a_h};
    {prod_sign_hi_f4a_h, s_res_f4a_h, s_res_check_cadd_a3_f4a_h, sc_f4a_h} <=
        {prod_sign_hi_f3a_h, s_res_f3a_h, s_res_check_cadd_a3_f3a_h, sc_f3a_h};
    {comp_res_sel_f4a_h,
     ...
     trans_log_rr_neg_f4a_h} <=
        {comp_res_sel_f3a_h,
         ...
         fround_stky2l_f3a_h,
         trans_log_rr_neg_f3a_h};
    use_prev_sigs_f4a_h <= use_prev_sigs_f3a_h;
    {ec_zero_f4a_h, fb_hi_zero_f4a_h} <= {ec_zero_f3a_h, fb_hi_zero_f3a_h};
    {res_inf_f4a_h,
     res_neg_inf_f4a_h,
     res_snan_f4a_h,
     res_qnan_f4a_h,
    ...
    if (flags_en_f3a_h) begin
      flags_f4a_h <= flags_f3a_h;
    end
  end
end
...
always_ff @(posedge clock) begin
  if (reset) begin
    ...
    ctrl_valid_f5a_h <= ctrl_valid_f4a_h;

    if (ctrl_valid_f4a_h) begin
      spec_res_en_f5a_h <= spec_res_en_f4a_h;
      flags_en_f5a_h    <= flags_en_f4a_h;

      if (!use_prev_sigs_f4a_h) begin
        {op_dtype_f5a_h,
         cmd_f5a_h,
         sigs_f5a_h,
         comp_op_f5a_h,
  ...
  if (ctrl_valid_f4a_h) begin
    int_minmax_mux_sel_a_f5a_h <= int_minmax_mux_sel_a_f4a_h;
    int_minmax_mux_sel_c_f5a_h <= int_minmax_mux_sel_c_f4a_h;
    {prod_sign_hi_f5a_h, ec_zero_f5a_h} <= {prod_sign_hi_f4a_h, ec_zero_f4a_h};
    {trans_log_rr_neg_f5a_h,
     comp_res_sel_f5a_h,
    ...
    {cvt_fui_pos_ovf_f5a_h,
     ...
     norm_one_out_f5a_h} <=
        {cvt_fui_pos_ovf_f4a_h,
         ...
         norm_f32_ovf_f4a_h,
         norm_one_out_f4a_h};
    use_prev_sigs_f5a_h <= use_prev_sigs_f4a_h;

    if (flags_en_f4a_h) begin
      flags_f5a_h <= flags_f4a_h;
    end
  end
end
...
always_ff @(posedge clock) begin
  if (reset) begin
    ...
    {eff_sub1_f6a_h,
     ...
     fround_stky2l_f6a_h,
     cvt_fi_min_neg_f6a_h} <= '0;
    ec_zero_f6a_h <= '0;
  end else begin
    ctrl_valid_f6a_h <= ctrl_valid_f5a_h;

    if (ctrl_valid_f5a_h) begin
      flags_en_f6a_h <= flags_en_f5a_h;
      ec_zero_f6a_h  <= ec_zero_f5a_h;

      if (!use_prev_sigs_f5a_h) begin
        {op_dtype_f6a_h,
         sigs_f6a_h,
         cmd_f6a_h,
         rm_f6a_h,
  ...
  if (ctrl_valid_f5a_h) begin
    ...
    if (flags_en_f5a_h) begin
      flags_f6a_h <= flags_f5a_h;
    end
  end
end
