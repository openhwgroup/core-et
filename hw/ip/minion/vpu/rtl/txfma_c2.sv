...
/* verilator lint_off CASEINCOMPLETE */  // Imported original TXFMA control decode preserves sparse selector coverage.
/* verilator lint_off UNUSEDSIGNAL */  // Packed control fields intentionally carry more bits than this stage consumes.
module txfma_c2
(
