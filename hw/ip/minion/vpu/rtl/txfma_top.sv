...
/* verilator lint_off SYNCASYNCNET */  // Imported original TXFMA pipeline mixes async-reset and sync-enable macros across staged valid bits.
/* verilator lint_off UNUSEDSIGNAL */  // The imported top keeps full packed operand/result buses even when some bits are unused in this configuration.
...
vpu_pkg::vpu_output_t                        txfma0_f6_out_data;
...
always_ff @(posedge clock) begin
  if (txfma0_ctrl_valid_f0a_h) begin
    {txfma0_ea_hi_f1a_h,
     txfma0_eb_hi_f1a_h,
     txfma0_ea_lo_f1a_h,
     txfma0_eb_lo_f1a_h,
     txfma0_ec_f1a_h} <= {txfma0_ea_hi_f0a_h,
                          txfma0_eb_hi_f0a_h,
                          txfma0_ea_lo_f0a_h,
                          txfma0_eb_lo_f0a_h,
                          txfma0_ec_f0a_h};
    txfma0_ec_all1_f1a_h <= txfma0_ec_all1_f0a_h;
  end
end
...
always_ff @(posedge clock) begin
  if (txfma0_ctrl_valid_f1a_h) begin
    txfma0_fa_en_f2a_h <= txfma0_fa_en_f1a_h;
    txfma0_ea_hi_f2a_h <= txfma0_ea_hi_f1a_h;
  end
  if (txfma0_ctrl_valid_f1a_h && txfma0_fa_en_f1a_h) begin
    txfma0_eb_hi_lsb_f2a_h <= txfma0_eb_hi_f1a_h[0];
  end
end
...
///////////////////////////////////////////////////////////////////////////////
always_ff @(posedge clock) begin
  if (txfma0_ctrl_valid_f2a_h) begin
    {txfma0_ediff1_f3a_h,
     txfma0_ea_hi_f3a_h} <= {txfma0_ediff1_f2a_h,
                             txfma0_ea_hi_f2a_h};
  end
  if (txfma0_ctrl_valid_f2a_h && txfma0_fa_en_f2a_h) begin
    txfma0_eb_hi_lsb_f3a_h <= txfma0_eb_hi_lsb_f2a_h;
  end
end
...
always_ff @(posedge clock) begin
  if (txfma0_ctrl_valid_f3a_h) begin
    txfma0_eb_hi_lsb_f4a_h <= txfma0_eb_hi_lsb_f3a_h;
    txfma0_ea_hi_f4a_h <= txfma0_ea_hi_f3a_h;
    txfma0_s_res_f4a_h <= txfma0_s_res_f3a_h;
  end
end
...
always_ff @(posedge clock) begin
  if (txfma0_ctrl_valid_f4a_h) begin
    {txfma0_ea_hi_f5a_h,
     txfma0_s_res_f5a_h} <= {txfma0_ea_hi_f4a_h,
                             txfma0_s_res_f4a_h};
  end
end
...
always_ff @(posedge clock) begin
  if (reset) begin
    {txfma0_rmode_f6a_h,
     ...
     txfma0_int32_stky2l_f6a_h} <= '0;
    txfma0_s_res_f6a_h <= '0;
    {txfma0_ph_allone2r_f6a_h,
     txfma0_ph_allone2l_f6a_h,
     txfma0_ps_allone2r_f6a_h,
     txfma0_ps_allone2l_f6a_h} <= '0;
  end else if (txfma0_ctrl_valid_f5a_h) begin
    {txfma0_rmode_f6a_h,
     txfma0_ph_stky2l_f6a_h,
     txfma0_ps_stky2l_f6a_h,
     txfma0_int32_stky2l_f6a_h} <= {txfma0_rmode_f5a_h,
                                    txfma0_ph_stky2l_f5a_h,
                                    txfma0_ps_stky2l_f5a_h,
                                    txfma0_int32_stky2l_f5a_h};
    txfma0_s_res_f6a_h <= txfma0_s_res_out_f5a_h;
    {txfma0_ph_allone2r_f6a_h,
     txfma0_ph_allone2l_f6a_h,
     txfma0_ps_allone2r_f6a_h,
     txfma0_ps_allone2l_f6a_h} <= {txfma0_ph_allone2r_f5a_h,
