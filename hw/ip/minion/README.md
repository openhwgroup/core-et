...
| vpu | In progress | `hw/ip/minion/vpu/` now exists with `vpu_pkg`, `vpu_bypass`, `vpu_mask`, `vpu_rf`, `vpu_sh_sw`, `txfma_csa`, `txfma_4_2_compressor`, `txfma_4_2_compressor_array`, `txfma_booth_ppg_32r4_norm`, `txfma_booth_ppg_32r4_msb`, `txfma_booth_ppg_32r4`, `txfma_wallace1`, `txfma_wallace2`, `txfma_lxd`, `txfma_trz`, `txfma_trz2`, `txfma_adder`, `txfma_align_shf`, `txfma_norm_shf`, `tima_adder`, `tima_top`, the generated `trans_*_rom_case_*` helpers, `trans_top`, `vpu_trans`, the four tensor RF wrappers, `vpu_lane_tima`, and `vpu_uinst_decoder`; the landed standalone VPU leafs currently pass `306,367` unit-test checks and `3,284,332` cosim comparisons, while the rest of the VPU subtree is still pending |
