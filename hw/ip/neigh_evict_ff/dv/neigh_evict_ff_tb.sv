...
(
  ...
  output logic [7:0]                         coop_evict_req_id_o,
  output logic [etlink_pkg::SourceSize-1:0]  coop_evict_req_source_o,
  output logic                               coop_evict_req_wdata_o,
  output logic [4:0]                         coop_evict_req_opcode_o,
  output logic [PaSize-1:0]                  coop_evict_req_address_o,
  output logic [63:0]                        coop_evict_req_data0_o,
  output logic [63:0]                        coop_evict_req_data1_o,
  output logic [63:0]                        coop_evict_req_data2_o,
  output logic [63:0]                        coop_evict_req_data3_o,
  output logic [2:0]                         coop_evict_req_size_o,
  output logic [EtLinkQwenSize-1:0]          coop_evict_req_qwen_o,
  output logic [EtLinkSubopcodeSize-1:0]     coop_evict_req_subopcode_o,
  ...
  etlink_pkg::neigh_req_t         coop_evict_req;
  ...
  always_comb begin
    ...
    coop_evict_req_id_o = coop_evict_req.id;
    coop_evict_req_source_o = coop_evict_req.source;
    coop_evict_req_wdata_o = coop_evict_req.wdata;
    coop_evict_req_opcode_o = coop_evict_req.opcode;
    coop_evict_req_address_o = coop_evict_req.address;
    {coop_evict_req_data3_o, coop_evict_req_data2_o, coop_evict_req_data1_o, coop_evict_req_data0_o} =
        coop_evict_req.data;
    coop_evict_req_size_o = coop_evict_req.size;
    coop_evict_req_qwen_o = coop_evict_req.qwen;
    coop_evict_req_subopcode_o = coop_evict_req.subopcode;
  end

  neigh_evict_ff u_dut (
    .shire_id_i,
    .neigh_id_i,
    .clk_i,
    .rst_ni,
    ...
    .evict_valid_o,
    .evict_ready_i,
    .coop_evict_req_o(coop_evict_req),
    .coop_evict_valid_o,
    .coop_evict_ready_i,
    .dbg_sm_signals_o
  );
