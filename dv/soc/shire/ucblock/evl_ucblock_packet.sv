class evl_ucblock_packet extends evl_monitor_packet;

   evl_trans_id_t       m_trans_id;
   int                  m_core_id;
   evl_ucblock_packet_u m_info;
   ...
   //    none
   //
   function void set_info(input evl_ucblock_packet_u info_in);
      m_info = info_in;
   ...
   //
   // Return Value:
   //    evl_ucblock_packet_u: This is the info of the request
   //
   function evl_ucblock_packet_u get_info();
      return m_info;
