class evl_memshire_packet extends evl_monitor_packet;

   evl_memshire_packet_u m_info;
   ...
   //    none
   //
   function void set_info(input evl_memshire_packet_u info_in);
      m_info = info_in;
   ...
   //
   // Return Value:
   //    evl_memshire_packet_u: This is the info of the request
   //
   function evl_memshire_packet_u get_info();
      return m_info;
   ...
   function new(input string                name_in,
                ...
                input evl_memshire_packet_u info_in);
      super.new(name_in, 0, packet_type_in, 0, evl_trans_id_t'(0), 0);
      m_info = info_in;
   endfunction : new

endclass : evl_memshire_packet
