class evl_standalone_minion_packet extends evl_monitor_packet;

   evl_trans_id_t     m_trans_id;    // dv-related-ID
   int                m_core_id;
   evl_standalone_minion_packet_u m_info;
   ...
   //    none
   //
   function void set_info(input evl_standalone_minion_packet_u info_in);
      m_info = info_in;
   ...
   //
   // Return Value:
   //    evl_standalone_minion_packet_u: This is the info of the request
   //
   function evl_standalone_minion_packet_u get_info();
      return m_info;
