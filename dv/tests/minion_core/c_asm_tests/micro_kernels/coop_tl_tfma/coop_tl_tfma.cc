...
// There are array entries for every iteration of the loop
...
int main()
{
    ...
    // This is not needed for VCS, but since we want to run on Zebu, use it here as well
