...
#define L2_SCP_ACTIVATION2_SOURCE_OFFSET (L2_SCP_ACTIVATION_SOURCE_OFFSET +L2_SCP_ACTIVATION_SOURCE_SIZE )
#define L2_SCP_ACTIVATION2_SOURCE_SIZE   2048


#define L2_SCP_RESULT_OFFSET            (L2_SCP_ACTIVATION2_SOURCE_OFFSET+L2_SCP_ACTIVATION2_SOURCE_SIZE)
#define L2_SCP_RESULT_SIZE              2048
