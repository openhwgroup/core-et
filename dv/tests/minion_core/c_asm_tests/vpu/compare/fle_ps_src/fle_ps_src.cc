...
int main()
{
   ...
   __compare("fle.ps",3,2,1);
   __compare("fle.ps",5,4,3);
   __compare("fle.ps",7,6,5);
   __compare("fle.ps",9,8,7);
   __compare("fle.ps",11,10,9);
   __compare("fle.ps",13,12,11);
   __compare("fle.ps",15,14,13);
   __compare("fle.ps",17,16,15);
   __compare("fle.ps",19,18,17);
   __compare("fle.ps",21,20,19);
   __compare("fle.ps",23,22,21);
   __compare("fle.ps",25,24,23);
   __compare("fle.ps",27,26,25);
   __compare("fle.ps",29,28,27);
