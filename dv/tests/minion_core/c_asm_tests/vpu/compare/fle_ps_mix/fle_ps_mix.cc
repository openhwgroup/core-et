...
int main()
{
   ...
   __compare("fle.ps",2,1,0);
   __compare("fle.ps",4,3,2);
   __compare("fle.ps",4,5,4);
   __compare("fle.ps",8,7,6);
   __compare("fle.ps",10,9,8);
   __compare("fle.ps",10,11,10);
   __compare("fle.ps",14,13,12);
   __compare("fle.ps",16,15,14);
   __compare("fle.ps",16,17,16);
   __compare("fle.ps",20,19,18);
   __compare("fle.ps",22,21,20);
   __compare("fle.ps",22,23,22);
   __compare("fle.ps",26,25,24);
   __compare("fle.ps",28,27,26);
   __compare("fle.ps",28,29,28);
