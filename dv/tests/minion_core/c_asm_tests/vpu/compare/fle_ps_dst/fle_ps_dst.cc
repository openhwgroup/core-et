...
int main()
{
   ...
   __compare("fle.ps",31,1,0);
   __compare("fle.ps",31,3,2);
   __compare("fle.ps",31,5,4);
   __compare("fle.ps",31,7,6);
   __compare("fle.ps",31,9,8);
   __compare("fle.ps",31,11,10);
   __compare("fle.ps",31,13,12);
   __compare("fle.ps",31,15,14);
   __compare("fle.ps",31,17,16);
   __compare("fle.ps",31,19,18);
   __compare("fle.ps",31,21,20);
   __compare("fle.ps",31,23,22);
   __compare("fle.ps",31,26,25);
   __compare("fle.ps",31,28,27);
   __compare("fle.ps",31,30,29);
