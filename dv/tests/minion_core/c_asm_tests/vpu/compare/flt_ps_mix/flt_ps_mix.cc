...
int main()
{
   ...
   __compare("flt.ps",2,1,0);
   __compare("flt.ps",4,3,2);
   __compare("flt.ps",4,5,4);
   __compare("flt.ps",8,7,6);
   __compare("flt.ps",10,9,8);
   __compare("flt.ps",10,11,10);
   __compare("flt.ps",14,13,12);
   __compare("flt.ps",16,15,14);
   __compare("flt.ps",16,17,16);
   __compare("flt.ps",20,19,18);
   __compare("flt.ps",22,21,20);
   __compare("flt.ps",22,23,22);
   __compare("flt.ps",26,25,24);
   __compare("flt.ps",28,27,26);
   __compare("flt.ps",28,29,28);
   __compare("flt.ps",31,30,29);
