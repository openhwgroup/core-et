...
int main()
{
   ...
   __compare("flt.ps",3,2,1);
   __compare("flt.ps",5,4,3);
   __compare("flt.ps",7,6,5);
   __compare("flt.ps",9,8,7);
   __compare("flt.ps",11,10,9);
   __compare("flt.ps",13,12,11);
   __compare("flt.ps",15,14,13);
   __compare("flt.ps",17,16,15);
   __compare("flt.ps",19,18,17);
   __compare("flt.ps",21,20,19);
   __compare("flt.ps",23,22,21);
   __compare("flt.ps",25,24,23);
   __compare("flt.ps",27,26,25);
   __compare("flt.ps",29,28,27);
