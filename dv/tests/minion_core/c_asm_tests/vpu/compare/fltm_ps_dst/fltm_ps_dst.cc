...
int main()
{
   ...
   __comparemask("fltm.ps",1,1,0);
   __comparemask("fltm.ps",1,3,2);
   __comparemask("fltm.ps",1,5,4);
   __comparemask("fltm.ps",1,7,6);
   __comparemask("fltm.ps",1,9,8);
   __comparemask("fltm.ps",1,11,10);
   __comparemask("fltm.ps",1,13,12);
   __comparemask("fltm.ps",1,15,14);
   __comparemask("fltm.ps",1,17,16);
   __comparemask("fltm.ps",1,19,18);
   __comparemask("fltm.ps",1,21,20);
   __comparemask("fltm.ps",1,23,22);
   __comparemask("fltm.ps",1,26,25);
   __comparemask("fltm.ps",1,28,27);
   __comparemask("fltm.ps",1,30,29);
