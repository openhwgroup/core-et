...
int main()
{
   ...
   __compareint("flt.s",3,1,0);
   __compareint("flt.s",3,3,2);
   __compareint("flt.s",3,5,4);
   __compareint("flt.s",3,7,6);
   __compareint("flt.s",3,9,8);
   __compareint("flt.s",3,11,10);
   __compareint("flt.s",3,13,12);
   __compareint("flt.s",3,15,14);
   __compareint("flt.s",3,17,16);
   __compareint("flt.s",3,19,18);
   __compareint("flt.s",3,21,20);
   __compareint("flt.s",3,23,22);
   __compareint("flt.s",3,26,25);
   __compareint("flt.s",3,28,27);
   __compareint("flt.s",3,30,29);
