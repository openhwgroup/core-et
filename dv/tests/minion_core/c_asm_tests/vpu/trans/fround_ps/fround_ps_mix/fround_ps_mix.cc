...
int main()
{
   ...
   __asm__ __volatile__ (
         ...
         "fround.ps f7,f8,dyn\n"
         "fround.ps f9,f9,dyn\n"
         "fround.ps f8,f10,dyn\n"
         "fround.ps f10,f11,dyn\n"
         "fround.ps f12,f12,dyn\n"
         "fround.ps f11,f13,dyn\n"
         "fround.ps f13,f14,dyn\n"
         "fround.ps f15,f15,dyn\n"
         "fround.ps f14,f16,dyn\n"
         "fround.ps f17,f17,dyn\n"
         "fround.ps f1,f18,dyn\n"
         "fround.ps f16,f19,dyn\n"
         "fround.ps f18,f20,dyn\n"
         "fround.ps f19,f21,dyn\n"
         "fround.ps f20,f22,dyn\n"
         "fround.ps f5,f23,dyn\n"
         "fround.ps f24,f24,dyn\n"
         "fround.ps f7,f25,dyn\n"
         "fround.ps f8,f26,dyn\n"
         "fround.ps f22,f27,dyn\n"
         "fround.ps f28,f28,dyn\n"
         "fround.ps f3,f29,dyn\n"
         "fround.ps f4,f30,dyn\n"
         "fround.ps f0,f31,dyn\n"
         : 
