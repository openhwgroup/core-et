...
int main()
{
   ...
   __asm__ __volatile__ (
         ...
         "fcvt.ps.rast f9,f9\n"
         "fcvt.ps.rast f8,f10\n"
         "fcvt.ps.rast f10,f11\n"
         "fcvt.ps.rast f12,f12\n"
         "fcvt.ps.rast f11,f13\n"
         "fcvt.ps.rast f13,f14\n"
         "fcvt.ps.rast f15,f15\n"
         "fcvt.ps.rast f14,f16\n"
         "fcvt.ps.rast f17,f17\n"
         "fcvt.ps.rast f1,f18\n"
         "fcvt.ps.rast f16,f19\n"
         "fcvt.ps.rast f18,f20\n"
         "fcvt.ps.rast f19,f21\n"
         "fcvt.ps.rast f20,f22\n"
         "fcvt.ps.rast f5,f23\n"
         "fcvt.ps.rast f24,f24\n"
         "fcvt.ps.rast f7,f25\n"
         "fcvt.ps.rast f8,f26\n"
         "fcvt.ps.rast f22,f27\n"
         "fcvt.ps.rast f28,f28\n"
         "fcvt.ps.rast f3,f29\n"
         "fcvt.ps.rast f4,f30\n"
         "fcvt.ps.rast f0,f31\n"
         : 
