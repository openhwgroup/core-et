...
int main()
{
   ...
   __asm__ __volatile__ (
         ...
         "fsgnjn.ps f13, f12, f11\n"
         "fsgnjn.ps f12, f13, f12\n"
         "fsgnjn.ps f14, f15, f14\n"
         "fsgnjn.ps f15, f14, f15\n"
         "fsgnjn.ps f16, f15, f16\n"
         "fsgnjn.ps f17, f16, f17\n"
         "fsgnjn.ps f18, f17, f18\n"
         "fsgnjn.ps f19, f18, f19\n"
         "fsgnjn.ps f20, f19, f20\n"
         "fsgnjn.ps f21, f20, f21\n"
         "fsgnjn.ps f22, f21, f22\n"
         "fsgnjn.ps f23, f22, f23\n"
         "fsgnjn.ps f24, f23, f24\n"
         "fsgnjn.ps f25, f24, f25\n"
         "fsgnjn.ps f26, f25, f26\n"
         "fsgnjn.ps f27, f26, f27\n"
         "fsgnjn.ps f28, f27, f28\n"
         "fsgnjn.ps f29, f28, f29\n"
         "fsgnjn.ps f30, f29, f30\n"
