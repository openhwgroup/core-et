...
int main()
{
   ...
   __asm__ __volatile__ (
         ...
         "fsgnjn.ps f31, f7, f8\n"
         "fsgnjn.ps f31, f8, f9\n"
         "fsgnjn.ps f31, f9, f10\n"
         "fsgnjn.ps f31, f10, f11\n"
         "fsgnjn.ps f31, f11, f12\n"
         "fsgnjn.ps f31, f12, f13\n"
         "fsgnjn.ps f31, f13, f14\n"
         "fsgnjn.ps f31, f14, f15\n"
         "fsgnjn.ps f31, f15, f16\n"
         "fsgnjn.ps f31, f16, f17\n"
         "fsgnjn.ps f31, f17, f18\n"
         "fsgnjn.ps f31, f18, f19\n"
         "fsgnjn.ps f31, f19, f20\n"
         "fsgnjn.ps f31, f20, f21\n"
         "fsgnjn.ps f31, f21, f22\n"
         "fsgnjn.ps f31, f22, f23\n"
         "fsgnjn.ps f31, f23, f24\n"
         "fsgnjn.ps f31, f24, f25\n"
         "fsgnjn.ps f31, f25, f26\n"
         "fsgnjn.ps f31, f26, f27\n"
         "fsgnjn.ps f31, f27, f28\n"
         "fsgnjn.ps f31, f28, f29\n"
         "fsgnjn.ps f31, f29, f30\n"
         "fsgnjn.ps f31, f30, f31\n"
