...
int main()
{
   ...
   __computational("fadd.ps",3,4,2);
   __computational("fadd.ps",5,6,4);
   __computational("fadd.ps",7,8,6);
   __computational("fadd.ps",6,9,8);
   __computational("fadd.ps",8,11,10);
   __computational("fadd.ps",9,13,12);
   __computational("fadd.ps",10,15,14);
   __computational("fadd.ps",11,17,16);
   __computational("fadd.ps",12,19,18);
   __computational("fadd.ps",13,21,20);
   __computational("fadd.ps",14,23,22);
   __computational("fadd.ps",15,26,25);
   __computational("fadd.ps",16,28,27);
   __computational("fadd.ps",17,30,29); 
