...
int main()
{
   ...
   __computational("fadd.ps",4,3,2);
   __computational("fadd.ps",6,5,4);
   __computational("fadd.ps",8,7,6);
   __computational("fadd.ps",10,9,8);
   __computational("fadd.ps",12,11,10);
   __computational("fadd.ps",14,13,12);
   __computational("fadd.ps",16,15,14);
   __computational("fadd.ps",18,17,16);
   __computational("fadd.ps",20,19,18);
   __computational("fadd.ps",22,21,20);
   __computational("fadd.ps",24,23,22);
   __computational("fadd.ps",27,26,25);
   __computational("fadd.ps",29,28,27);
