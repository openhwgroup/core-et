...
int main()
{
   ...
   __computational("fadd.s",4,3,2);
   __computational("fadd.s",6,5,4);
   __computational("fadd.s",8,7,6);
   __computational("fadd.s",10,9,8);
   __computational("fadd.s",12,11,10);
   __computational("fadd.s",14,13,12);
   __computational("fadd.s",16,15,14);
   __computational("fadd.s",18,17,16);
   __computational("fadd.s",20,19,18);
   __computational("fadd.s",22,21,20);
   __computational("fadd.s",24,23,22);
   __computational("fadd.s",27,26,25);
   __computational("fadd.s",29,28,27);
