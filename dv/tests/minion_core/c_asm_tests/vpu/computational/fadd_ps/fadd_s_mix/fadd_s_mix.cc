...
int main()
{
   ...
   __computational("fadd.s",2,1,0);
   __computational("fadd.s",3,4,2);
   __computational("fadd.s",5,6,4);
   __computational("fadd.s",7,8,6);
   __computational("fadd.s",6,9,8);
   __computational("fadd.s",8,11,10);
   __computational("fadd.s",9,13,12);
   __computational("fadd.s",10,15,14);
   __computational("fadd.s",11,17,16);
   __computational("fadd.s",12,19,18);
   __computational("fadd.s",13,21,20);
   __computational("fadd.s",14,23,22);
   __computational("fadd.s",15,26,25);
   __computational("fadd.s",16,28,27);
   __computational("fadd.s",17,30,29); 
