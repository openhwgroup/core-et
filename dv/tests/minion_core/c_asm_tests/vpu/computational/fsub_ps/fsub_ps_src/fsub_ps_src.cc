...
int main()
{
   ...
   __computational("fsub.ps",8,7,6);
   __computational("fsub.ps",10,9,8);
   __computational("fsub.ps",12,11,10);
   __computational("fsub.ps",14,13,12);
   __computational("fsub.ps",16,15,14);
   __computational("fsub.ps",18,17,16);
   __computational("fsub.ps",20,19,18);
   __computational("fsub.ps",22,21,20);
   __computational("fsub.ps",24,23,22);
   __computational("fsub.ps",26,25,24);
   __computational("fsub.ps",28,27,26);
   __computational("fsub.ps",30,29,28);
