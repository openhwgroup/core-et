...
int main()
{
   ...
   __computational("fsub.s",4,5,6);
   __computational("fsub.s",7,6,5);
   __computational("fsub.s",8,7,9);
   __computational("fsub.s",10,8,11);
   __computational("fsub.s",10,12,13); // BEMU bug - handling denormals
   __computational("fsub.s",11,14,15); // BEMU bug - handling denormals
   __computational("fsub.s",9,16,17);
   __computational("fsub.s",10,18,19);
   __computational("fsub.s",18,20,10);
   __computational("fsub.s",20,21,22);
   __computational("fsub.s",21,23,24);
