...
int main()
{
   ...
   __computational("fsub.s",31,1,0);
   __computational("fsub.s",31,3,2);
   __computational("fsub.s",31,5,4);
   __computational("fsub.s",31,7,6);
   __computational("fsub.s",31,9,8);
   __computational("fsub.s",31,11,10);
   __computational("fsub.s",31,13,12); //BUG: handling denormals
   __computational("fsub.s",31,15,14); //BUG: handling denormals
   __computational("fsub.s",31,17,16);
   __computational("fsub.s",31,19,18);
   __computational("fsub.s",31,21,20);
   __computational("fsub.s",31,23,22);
   __computational("fsub.s",31,26,25); //BUG: handling denormals
   __computational("fsub.s",31,28,27); //BUG: handling denormals
   //__computational("fsub.s",31,30,29); //BUG: handling denormals
