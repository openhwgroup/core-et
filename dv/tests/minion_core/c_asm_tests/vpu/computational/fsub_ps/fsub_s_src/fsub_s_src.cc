...
int main()
{
   ...
   __computational("fsub.s",2,1,0);
   __computational("fsub.s",4,3,2);
   __computational("fsub.s",6,5,4);
   __computational("fsub.s",8,7,6);
   __computational("fsub.s",10,9,8);
   __computational("fsub.s",12,11,10);
   __computational("fsub.s",14,13,12);
   __computational("fsub.s",16,15,14);
   __computational("fsub.s",18,17,16);
   __computational("fsub.s",20,19,18);
   __computational("fsub.s",22,21,20);
   __computational("fsub.s",24,23,22);
   __computational("fsub.s",26,25,24);
   __computational("fsub.s",28,27,26);
   __computational("fsub.s",30,29,28);
