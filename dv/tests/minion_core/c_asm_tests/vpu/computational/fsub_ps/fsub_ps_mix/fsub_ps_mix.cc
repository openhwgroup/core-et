...
int main()
{
   ...
   // Instruction - mixing
   __computational("fsub.ps",2,1,0);
   __computational("fsub.ps",4,3,2);
   __computational("fsub.ps",4,5,6);
   __computational("fsub.ps",7,6,5);
   __computational("fsub.ps",8,7,9);
   __computational("fsub.ps",10,8,11);
   //__computational("fsub.ps",10,12,13); // BEMU bug - handling denormals
   //__computational("fsub.ps",11,14,15); // BEMU bug - handling denormals
   __computational("fsub.ps",9,16,17);
   __computational("fsub.ps",10,18,19);
   __computational("fsub.ps",18,20,10);
   __computational("fsub.ps",20,21,22);
   __computational("fsub.ps",21,23,24);
