...
int main()
{
   ...
   __computational4("fnmadd.ps",4,3,2,3);
   __computational4("fnmadd.ps",6,4,5,2);
   __computational4("fnmadd.ps",7,5,8,6);
   __computational4("fnmadd.ps",8,10,9,7);
   __computational4("fnmadd.ps",10,11,8,5);
   __computational4("fnmadd.ps",21,8,7,6);
   __computational4("fnmadd.ps",31,9,22,18);
   __computational4("fnmadd.ps",31,10,12,8);
