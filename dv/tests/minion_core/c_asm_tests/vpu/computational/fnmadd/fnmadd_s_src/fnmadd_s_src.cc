...
int main()
{
   ...
   __computational4("fnmadd.ps",3,2,1,0);
   __computational4("fnmadd.ps",6,5,4,3);
   __computational4("fnmadd.ps",9,8,7,6);
   __computational4("fnmadd.ps",12,11,10,9);
   __computational4("fnmadd.ps",15,14,13,12);
   __computational4("fnmadd.ps",18,17,16,15);
   __computational4("fnmadd.ps",21,20,19,18);
   __computational4("fnmadd.ps",24,23,22,21);
   __computational4("fnmadd.ps",27,26,25,24);
   __computational4("fnmadd.ps",30,29,28,27); 
