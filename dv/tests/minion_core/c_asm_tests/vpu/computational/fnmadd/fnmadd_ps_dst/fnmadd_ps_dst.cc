...
int main()
{
   ...
   __computational4("fnmadd.ps",31,2,1,0);
   __computational4("fnmadd.ps",31,3,2,1);
   __computational4("fnmadd.ps",31,4,3,2);
   __computational4("fnmadd.ps",31,5,4,3);
   __computational4("fnmadd.ps",31,6,5,4);
   __computational4("fnmadd.ps",31,7,6,5);
   __computational4("fnmadd.ps",31,8,7,6);
   __computational4("fnmadd.ps",31,9,8,7);
   __computational4("fnmadd.ps",31,10,9,8);
   __computational4("fnmadd.ps",31,11,10,9);
   __computational4("fnmadd.ps",31,12,11,10);
   __computational4("fnmadd.ps",31,13,12,11);
   __computational4("fnmadd.ps",31,14,13,12);
   __computational4("fnmadd.ps",31,15,14,13);
   __computational4("fnmadd.ps",31,16,15,14);
   __computational4("fnmadd.ps",31,17,16,15);
   __computational4("fnmadd.ps",31,18,17,16);
   __computational4("fnmadd.ps",31,19,18,17);
   __computational4("fnmadd.ps",31,20,19,18);
   __computational4("fnmadd.ps",31,21,20,19);
   __computational4("fnmadd.ps",31,22,21,20);
   __computational4("fnmadd.ps",31,23,22,21);
   __computational4("fnmadd.ps",31,24,23,22);
   __computational4("fnmadd.ps",31,26,25,24);
   __computational4("fnmadd.ps",31,27,26,25);
   __computational4("fnmadd.ps",31,28,27,26);
   __computational4("fnmadd.ps",31,29,28,27);
   __computational4("fnmadd.ps",31,30,29,28); 
