...
int main()
{
   ...
   __computational("fmulh.pi",6,5,4);
   __computational("fmulh.pi",8,7,6);
   __computational("fmulh.pi",10,9,8);
   __computational("fmulh.pi",12,11,10);
   __computational("fmulh.pi",14,13,12);
   __computational("fmulh.pi",16,15,14);
   __computational("fmulh.pi",18,17,16);
   __computational("fmulh.pi",20,19,18);
   __computational("fmulh.pi",22,21,20);
   __computational("fmulh.pi",24,23,22);
   __computational("fmulh.pi",27,26,25);
   __computational("fmulh.pi",29,28,27);
