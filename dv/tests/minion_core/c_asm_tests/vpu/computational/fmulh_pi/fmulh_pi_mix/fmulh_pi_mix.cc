...
int main()
{
   ...
   __computational("fmulh.pi",2,1,0);
   __computational("fmulh.pi",4,3,2);
   __computational("fmulh.pi",2,5,4);
   __computational("fmulh.pi",8,7,6);
   __computational("fmulh.pi",1,9,8);
   __computational("fmulh.pi",10,11,1);
   __computational("fmulh.pi",14,13,12);
   __computational("fmulh.pi",9,15,14);
   __computational("fmulh.pi",13,17,16);
   __computational("fmulh.pi",20,19,13);
   __computational("fmulh.pi",14,21,20);
   __computational("fmulh.pi",24,23,21);
   __computational("fmulh.pi",0,26,24);
   __computational("fmulh.pi",30,28,10);
