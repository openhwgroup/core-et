...
int main()
{
   ...
   __computational4("fmsub.ps",31,2,1,0);
   __computational4("fmsub.ps",31,3,2,1);
   __computational4("fmsub.ps",31,5,4,3);
   __computational4("fmsub.ps",31,7,6,5);
   //__computational4("fmsub.ps",31,9,8,7); //BUG: handling denormals
   //__computational4("fmsub.ps",31,11,10,9); //BUG: handling denormals
   __computational4("fmsub.ps",31,13,12,11); 
   __computational4("fmsub.ps",31,15,14,10); 
   __computational4("fmsub.ps",31,17,16,15);
   __computational4("fmsub.ps",31,19,18,17);
   __computational4("fmsub.ps",31,21,20,19);
   __computational4("fmsub.ps",31,23,22,21);
   __computational4("fmsub.ps",31,26,25,24); 
   __computational4("fmsub.ps",31,28,27,26); 
