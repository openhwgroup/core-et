...
int main()
{
   ...
   __computational4("fmsub.ps",8,0,1,2);
   __computational4("fmsub.ps",5,4,7,1);
   __computational4("fmsub.ps",2,6,3,5);
   __computational4("fmsub.ps",1,7,2,7);
   __computational4("fmsub.ps",0,5,5,4);
   __computational4("fmsub.ps",7,1,6,0);
   __computational4("fmsub.ps",17,11,9,10);
   __computational4("fmsub.ps",27,20,15,18);
