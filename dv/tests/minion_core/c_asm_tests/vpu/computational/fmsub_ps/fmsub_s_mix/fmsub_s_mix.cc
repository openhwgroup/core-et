...
int main()
{
   ...
   __computational4("fmsub.s",8,0,1,2);
   __computational4("fmsub.s",5,4,7,1);
   __computational4("fmsub.s",2,6,3,5);
   __computational4("fmsub.s",1,7,2,7);
   __computational4("fmsub.s",0,5,5,4);
   __computational4("fmsub.s",7,1,6,0);
   __computational4("fmsub.s",17,11,9,10);
   __computational4("fmsub.s",27,20,15,18);
