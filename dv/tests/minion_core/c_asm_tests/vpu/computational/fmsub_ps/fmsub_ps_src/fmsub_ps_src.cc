...
int main()
{
   ...
   __computational4("fmsub.ps",3,2,1,0);
   __computational4("fmsub.ps",4,3,2,1);
   __computational4("fmsub.ps",5,4,3,2);
   __computational4("fmsub.ps",6,5,4,3);
   __computational4("fmsub.ps",7,6,5,4);
   __computational4("fmsub.ps",8,7,6,5);
   __computational4("fmsub.ps",9,8,7,6);
   __computational4("fmsub.ps",10,9,8,7);
   __computational4("fmsub.ps",11,10,9,8);
   __computational4("fmsub.ps",12,11,10,9);
   __computational4("fmsub.ps",13,12,11,10);
   __computational4("fmsub.ps",14,13,12,11);
   __computational4("fmsub.ps",15,14,13,12);
   /*__computational4("fmsub.ps",16,15,14,13);
     __computational4("fmsub.ps",17,16,15,14);
     __computational4("fmsub.ps",18,17,16,15);
     __computational4("fmsub.ps",19,18,17,16);
     __computational4("fmsub.ps",20,19,18,17);
     __computational4("fmsub.ps",21,20,19,18);
     __computational4("fmsub.ps",22,21,20,19);
     __computational4("fmsub.ps",23,22,21,20);
     __computational4("fmsub.ps",24,23,22,21);
     __computational4("fmsub.ps",25,24,23,22);
     __computational4("fmsub.ps",26,25,24,23);
     __computational4("fmsub.ps",27,26,25,24);
     __computational4("fmsub.ps",28,27,26,25);
     __computational4("fmsub.ps",29,28,27,26);
     __computational4("fmsub.ps",30,29,28,27);
     __computational4("fmsub.ps",31,30,29,28);*/
