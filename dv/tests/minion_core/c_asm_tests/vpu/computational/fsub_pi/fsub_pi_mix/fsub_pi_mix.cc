...
int main()
{
   ...
   // Instruction - mixing
   __computational("fsub.pi",2,1,0);
   __computational("fsub.pi",4,3,2);
   __computational("fsub.pi",4,5,6);
   __computational("fsub.pi",7,6,5);
   __computational("fsub.pi",8,7,9);
   __computational("fsub.pi",10,8,11);
   //__computational("fsub.pi",10,12,13); // BEMU bug - handling denormals
   //__computational("fsub.pi",11,14,15); // BEMU bug - handling denormals
   __computational("fsub.pi",9,16,17);
   __computational("fsub.pi",10,18,19);
   __computational("fsub.pi",18,20,10);
   __computational("fsub.pi",20,21,22);
   __computational("fsub.pi",21,23,24);
