...
int main()
{
   ...
   __computational("fsub.pi",6,5,4);
   __computational("fsub.pi",8,7,6);
   __computational("fsub.pi",10,9,8);
   __computational("fsub.pi",12,11,10);
   __computational("fsub.pi",14,13,12);
   __computational("fsub.pi",16,15,14);
   __computational("fsub.pi",18,17,16);
   __computational("fsub.pi",20,19,18);
   __computational("fsub.pi",22,21,20);
   __computational("fsub.pi",24,23,22);
   __computational("fsub.pi",26,25,24);
   __computational("fsub.pi",28,27,26);
   __computational("fsub.pi",30,29,28);
