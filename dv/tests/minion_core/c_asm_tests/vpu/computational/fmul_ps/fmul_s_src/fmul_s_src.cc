...
int main()
{
   ...
   __computational("fmul.s",4,3,2);
   __computational("fmul.s",6,5,4);
   __computational("fmul.s",8,7,6);
   __computational("fmul.s",10,9,8);
   __computational("fmul.s",12,11,10);
   __computational("fmul.s",14,13,12);
   __computational("fmul.s",16,15,14);
   __computational("fmul.s",18,17,16);
   __computational("fmul.s",20,19,18);
   __computational("fmul.s",22,21,20);
   __computational("fmul.s",24,23,22);
   __computational("fmul.s",27,26,25);
   __computational("fmul.s",29,28,27);
