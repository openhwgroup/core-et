...
int main()
{
   ...
   // Instruction - mixing dst and src reg
   __computational("fmul.s",2,1,0);
   __computational("fmul.s",0,3,2);
   __computational("fmul.s",1,5,4);
   __computational("fmul.s",2,7,6);
   __computational("fmul.s",3,9,8);
   __computational("fmul.s",4,11,10);
   __computational("fmul.s",5,13,12);
   __computational("fmul.s",6,15,14);
   __computational("fmul.s",7,17,16);
   __computational("fmul.s",8,19,18);
   __computational("fmul.s",9,21,20);
   __computational("fmul.s",10,23,22);
   __computational("fmul.s",11,26,25);
   __computational("fmul.s",12,28,27);
   __computational("fmul.s",13,30,29); 
