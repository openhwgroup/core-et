...
int main()
{
   ...
   __computational("fmul.s",31,1,0);
   __computational("fmul.s",31,3,2);
   __computational("fmul.s",31,5,4);
   __computational("fmul.s",31,7,6);
   __computational("fmul.s",31,9,8);
   __computational("fmul.s",31,11,10);
   __computational("fmul.s",31,13,12);
   __computational("fmul.s",31,15,14);
   __computational("fmul.s",31,17,16);
   __computational("fmul.s",31,19,18);
   __computational("fmul.s",31,21,20);
   __computational("fmul.s",31,23,22);
   __computational("fmul.s",31,26,25);
   __computational("fmul.s",31,28,27);
   __computational("fmul.s",31,30,29); 
