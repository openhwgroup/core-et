...
int main()
{
   ...
   __computational("fmulhu.pi",2,1,0);
   __computational("fmulhu.pi",4,3,2);
   __computational("fmulhu.pi",2,5,4);
   __computational("fmulhu.pi",8,7,6);
   __computational("fmulhu.pi",1,9,8);
   __computational("fmulhu.pi",10,11,1);
   __computational("fmulhu.pi",14,13,12);
   __computational("fmulhu.pi",9,15,14);
   __computational("fmulhu.pi",13,17,16);
   __computational("fmulhu.pi",20,19,13);
   __computational("fmulhu.pi",14,21,20);
   __computational("fmulhu.pi",24,23,21);
   __computational("fmulhu.pi",0,26,24);
   __computational("fmulhu.pi",30,28,10);
