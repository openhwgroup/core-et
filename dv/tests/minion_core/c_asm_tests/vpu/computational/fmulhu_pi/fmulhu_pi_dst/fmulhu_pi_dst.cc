...
int main()
{
   ...
   __computational("fmulhu.pi",31,1,0);
   __computational("fmulhu.pi",31,3,2);
   __computational("fmulhu.pi",31,5,4);
   __computational("fmulhu.pi",31,7,6);
   __computational("fmulhu.pi",31,9,8);
   __computational("fmulhu.pi",31,11,10);
   __computational("fmulhu.pi",31,13,12);
   __computational("fmulhu.pi",31,15,14);
   __computational("fmulhu.pi",31,17,16);
   __computational("fmulhu.pi",31,19,18);
   __computational("fmulhu.pi",31,21,20);
   __computational("fmulhu.pi",31,23,22);
   __computational("fmulhu.pi",31,26,25);
   __computational("fmulhu.pi",31,28,27);
   __computational("fmulhu.pi",31,30,29); 
