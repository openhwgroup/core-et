...
int main()
{
   ...
   __computational("fmulhu.pi",6,5,4);
   __computational("fmulhu.pi",8,7,6);
   __computational("fmulhu.pi",10,9,8);
   __computational("fmulhu.pi",12,11,10);
   __computational("fmulhu.pi",14,13,12);
   __computational("fmulhu.pi",16,15,14);
   __computational("fmulhu.pi",18,17,16);
   __computational("fmulhu.pi",20,19,18);
   __computational("fmulhu.pi",22,21,20);
   __computational("fmulhu.pi",24,23,22);
   __computational("fmulhu.pi",27,26,25);
   __computational("fmulhu.pi",29,28,27);
