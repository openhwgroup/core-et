...
int main()
{
   ...
   __computational4("fmadd.s",3,2,1,0);
   __computational4("fmadd.s",6,5,4,3);
   __computational4("fmadd.s",9,8,7,6);
   __computational4("fmadd.s",12,11,10,9);
   __computational4("fmadd.s",15,14,13,12);
   __computational4("fmadd.s",18,17,16,15);
   __computational4("fmadd.s",21,20,19,18);
   __computational4("fmadd.s",24,23,22,21);
   __computational4("fmadd.s",27,26,25,24);
   __computational4("fmadd.s",30,29,28,27);
