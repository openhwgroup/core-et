...
int main()
{
   ...
   __computational4("fmadd.ps",4,3,2,3);
   __computational4("fmadd.ps",6,4,5,2);
   __computational4("fmadd.ps",7,5,8,6);
   __computational4("fmadd.ps",8,10,9,7);
   __computational4("fmadd.ps",10,11,8,5);
   __computational4("fmadd.ps",21,8,7,6);
   __computational4("fmadd.ps",31,9,22,18);
   __computational4("fmadd.ps",31,10,12,8);
