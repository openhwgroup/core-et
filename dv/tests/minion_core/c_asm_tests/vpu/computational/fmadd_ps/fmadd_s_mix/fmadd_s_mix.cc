...
int main()
{
   ...
   __computational4("fmadd.s",4,3,2,3);
   __computational4("fmadd.s",6,4,5,2);
   __computational4("fmadd.s",7,5,8,6);
   __computational4("fmadd.s",8,10,9,7);
   __computational4("fmadd.s",10,11,8,5);
   __computational4("fmadd.s",21,8,7,6);
   __computational4("fmadd.s",31,9,22,18);
   __computational4("fmadd.s",31,10,12,8);
