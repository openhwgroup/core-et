...
///tensor_load_vpu
        ...
        "li x31, 0x40\n"
        "li x6,  0xf \n"
        "add x5, x6, x5\n"    //   use_tmask [63:63] = 0x0,  use_coop [62:62] = 0x0,  dst_start [58:53] = 0x0,  num_lines [3:0] = 0xf, vaddr = %[m_14]
        "li x7,  0x0200000000000000 \n"
        "add x5, x7, x5\n"    //   use_tmask [63:63] = 0x0,  use_coop [62:62] = 0x0,  dst_start [58:53] = 010000,  num_lines [3:0] = 0xf, vaddr = %[m_14]
...
"add x5, x5, x4 \n "
"csrrw zero,  0x83f, x5 \n "
"li x6,  0x1ff800000910007 \n "
//"li x6,  0x1fff80000f10007 \n "
"csrrw zero,  0x801, x6 \n "
"csrwi 0x830, 0x7 \n "
...
"li x1,  0x100 \n "
	...
	"LBL_clear_another_word:\n"
///////////// force 32-bit number to 0

"csrw	0x7e0, 0\n"  // SCP Off
"csrwi   0x830, 0x6\n"  // wait cacheop
"add x17, x17, 4\n"  
"flw f0,  0 (x17)\n" // load value only for debug
"fmv.s.x  f0,x0\n"   // zero out
"fsw f0,  0 (x17)\n" // store back
"li x4,  0x0c00000000000000\n " 
"add x4, x17, x4\n"  
"csrw 0x89f, x4\n"  // evict
"csrwi   0x830, 0x6\n"  // wait cacheop
"csrw	0x7e0, 1\n"  // SCP On
"fence\n"            // needed (VERIF-3295; PRM-8)
"csrw	0x7e0, 3\n"  // SCP On
...
"add x1, x1, -1\n"  
"bne x1, x0, LBL_clear_another_word\n"
