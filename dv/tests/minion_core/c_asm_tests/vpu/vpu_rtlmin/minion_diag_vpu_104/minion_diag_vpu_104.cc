...
int main() {
	...
	volatile uint32_t m_11[1024] __attribute__ ((aligned (4096))) = {
			 ...
			 0x80020000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00008
			 ...
			 0xff7ffffe, // max norm - 1ulp                               // max norm -ve                                /// 002d8
			 ...
			 0x00000001,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00348
			 ...
			 0xbf800001, // 1  + 1ulp                                     // SP - ve numbers                             /// 00378
			 ...
			 0x00800003,                                                  // none of the mantissa set to +3ulp           /// 0039c
			 0x0c7f0000,                                                  // Leading 1s:                                 /// 003a0
			 0x0c7ffff0,                                                  // Leading 1s:                                 /// 003a4
			 ...
			 0x0e000007,                                                  // Trailing 1s:                                /// 003e4
			 0xff7ffffe, // max norm - 1ulp                               // SP - ve numbers                             /// 003e8
			 ...
			 0x80800000,                                                  // none of the mantissa set to +3ulp           /// 0044c
			 ...
			 0x00ffffff, // norm with min exp, max mant                   // SP +ve numbers                              /// 00468
			 ...
			 0xffbfffff, // SNaN                                          // SP - ve numbers                             /// 00500
			 ...
			 0x80004000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00568
			 ...
			 0x33333333,                                                  // 4 random values                             /// 005dc
			 ...
			 0x8f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 00618
			 0x80000000,                                                  // -zero                                       /// 0061c
			 0xbf800000, // 1                                             // SP - ve numbers                             /// 00620
			 ...
			 0x00010000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00690
			 ...
			 0x00000020,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00848
			 ...
			 0x00800001, // min norm + 1ulp                               // SP +ve numbers                              /// 008cc
			 0x3f800000, // 1                                             // SP +ve numbers                              /// 008d0
			 0x0e03ffff,                                                  // Trailing 1s:                                /// 008d4
			 ...
			 0x00002000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 009b8
			 ...
			 0x80000001,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00a08
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00b3c
			 0x80800003, // min norm + 3ulp                               // subnormals -ve                              /// 00b40
			 0x00000002, // min subnorm + 1 ulp                           // SP +ve numbers                              /// 00b44
			 ...
			 0x00000004,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00b7c
			 ...
			 0x00000000,                                                  // zero                                        /// 00ba8
			 0x007ffffe, // max subnorm - 1ulp                            // SP +ve numbers                              /// 00bac
			 0x80000002,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00bb0
			 ...
			 0x80010000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00be4
			 ...
			 0x80008000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00c24
			 0x0e01ffff,                                                  // Trailing 1s:                                /// 00c28
			 0x80011111,                                                  // -9.7958E-41                                 /// 00c2c
			 0x80040000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00c30
			 ...
			 0x80000001, // min subnorm                                   // SP - ve numbers                             /// 00c4c
			 ...
			 0x0f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 00c78
			 ...
			 0x00ffffff, // norm with min exp, max mant                   // SP +ve numbers                              /// 00d58
			 ...
			 0x80100000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00dbc
			 ...
			 0xffc00001,                                                  // -signaling NaN                              /// 00df0
			 ...
			 0x80000010,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00e50
			 ...
			 0x0e001fff,                                                  // Trailing 1s:                                /// 00ef8
			 0x0f7fffff,                                                  // all bit of mantissa set upto -3ulp          /// 00efc
			 0x0e0001ff,                                                  // Trailing 1s:                                /// 00f00
			 0x7f000000, // norm with max exp, min mant                   // SP +ve numbers                              /// 00f04
			 ...
			 0x7f7fffff, // max norm                                      // max norm +ve                                /// 00fb8
			 0xffc00001,                                                  // -signaling NaN                              /// 00fbc
			 0x00000002,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00fc0
			 0x0e1fffff,                                                  // Trailing 1s:                                /// 00fc4
			 0x80000800,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00fc8
			 0x4b000000,                                                  // 8388608.0                                   /// 00fcc
			 ...
			 0x7fc00000 // DefaultNan                                    // SP +ve numbers                              /// last
	};
	volatile uint32_t m_12[1024] __attribute__ ((aligned (4096))) = {
			 ...
			 0xAAAAAAAA,                                                  // 4 random values                             /// 00060
			 0x0c7fff80,                                                  // Leading 1s:                                 /// 00064
			 0x0c7ff000,                                                  // Leading 1s:                                 /// 00068
			 0x0c7fff80,                                                  // Leading 1s:                                 /// 0006c
			 ...
			 0x7f800000, // infinity                                      // SP +ve numbers                              /// 000a8
			 ...
			 0xbf800000, // 1                                             // SP - ve numbers                             /// 001d8
			 ...
			 0x00004000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00220
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00244
			 ...
			 0x80000080,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00300
			 ...
			 0x80000008,                                                  // SP - 1 bit alone set in mantissa -ve        /// 0037c
			 ...
			 0x0e000001,                                                  // Trailing 1s:                                /// 00424
			 0x007fffff,                                                  // 1.1754942E-38                               /// 00428
			 ...
			 0x80000001, // min subnorm                                   // SP - ve numbers                             /// 00490
			 ...
			 0x80000002,                                                  // SP - 1 bit alone set in mantissa -ve        /// 004d4
			 ...
			 0x00040000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 004e8
			 ...
			 0x00800000, // min norm                                      // subnormals +ve                              /// 00584
			 0x7f7fffff, // max norm                                      // max norm +ve                                /// 00588
			 0xff800000,                                                  // -inf                                        /// 0058c
			 ...
			 0x00800000,                                                  // none of the mantissa set to +3ulp           /// 005f0
			 0x80020000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 005f4
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 005f8
			 0x7fffffff, // QNan                                          // SP +ve numbers                              /// 005fc
			 0x0c7ff000,                                                  // Leading 1s:                                 /// 00600
			 0x0e000003,                                                  // Trailing 1s:                                /// 00604
			 0xff800000,                                                  // -inf                                        /// 00608
			 ...
			 0x55555555,                                                  // 4 random values                             /// 00640
			 0x0f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00644
			 ...
			 0x80800001, // min norm + 1ulp                               // subnormals -ve                              /// 00690
			 ...
			 0x00000000, // 0                                             // SP +ve numbers                              /// 006c8
			 ...
			 0x80000001,                                                  // -1.4E-45 (-denorm)                          /// 00714
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00718
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00740
			 ...
			 0xffbfffff, // SNaN                                          // SP - ve numbers                             /// 008e0
			 ...
			 0x80010000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 008f4
			 ...
			 0x80000010,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00970
			 ...
			 0x00800001, // min norm + 1ulp                               // subnormals +ve                              /// 00984
			 ...
			 0x0f7fffff,                                                  // all bit of mantissa set upto -3ulp          /// 009fc
			 ...
			 0x00000040,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00ae0
			 0x807fffff, // max subnorm                                   // SP - ve numbers                             /// 00ae4
			 0x7f800001, // SNaN                                          // SP +ve numbers                              /// 00ae8
			 ...
			 0x80001000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00b38
			 0x00000001,                                                  // 1.4E-45 (+denorm)                           /// 00b3c
			 ...
			 0x80800000, // min norm                                      // subnormals -ve                              /// 00b78
			 ...
			 0x0e001fff,                                                  // Trailing 1s:                                /// 00be8
			 0x00000800,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00bec
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00c28
			 ...
			 0x00001000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00c9c
			 ...
			 0x00800002, // min norm + 2ulp                               // subnormals +ve                              /// 00ccc
			 ...
			 0x00800002,                                                  // none of the mantissa set to +3ulp           /// 00d20
			 ...
			 0x00800003, // min norm + 3ulp                               // subnormals +ve                              /// 00d4c
			 0x80200000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d50
			 0xff7ffffe, // max norm - 1ulp                               // max norm -ve                                /// 00d54
			 0x80000002,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d58
			 ...
			 0x80ffffff, // norm with min exp, max mant                   // SP - ve numbers                             /// 00d90
			 ...
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00db0
			 ...
			 0x80008000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00dd8
			 ...
			 0x7fc00001,                                                  // signaling NaN                               /// 00e20
			 ...
			 0x0f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00e64
			 ...
			 0x80040000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00eb0
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00f48
			 0xAAAAAAAA,                                                  // 4 random values                             /// 00f4c
	...
	volatile uint32_t m_13[1024] __attribute__ ((aligned (4096))) = {
			 ...
			 0xff000000, // norm with max exp, min mant                   // SP - ve numbers                             /// 00024
			 ...
			 0x00000008,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00140
			 ...
			 0x0e01ffff,                                                  // Trailing 1s:                                /// 00178
			 0x0e00007f,                                                  // Trailing 1s:                                /// 0017c
			 0xAAAAAAAA,                                                  // 4 random values                             /// 00180
			 ...
			 0xffffffff, // QNan                                          // SP - ve numbers                             /// 001ac
			 ...
			 0x80000008,                                                  // SP - 1 bit alone set in mantissa -ve        /// 001c4
			 ...
			 0x00000008,                                                  // SP - 1 bit alone set in mantissa +ve        /// 001d8
			 ...
			 0x00800002,                                                  // none of the mantissa set to +3ulp           /// 00244
			 ...
			 0x00100000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 002c4
			 0x00000800,                                                  // SP - 1 bit alone set in mantissa +ve        /// 002c8
			 0x0e000001,                                                  // Trailing 1s:                                /// 002cc
			 0x00800001, // min norm + 1ulp                               // subnormals +ve                              /// 002d0
			 0x00011111,                                                  // 9.7958E-41                                  /// 002d4
			 0x0c7ffff8,                                                  // Leading 1s:                                 /// 002d8
			 0x7f000000, // norm with max exp, min mant                   // SP +ve numbers                              /// 002dc
			 ...
			 0xff7ffffe, // max norm - 3ulp                               // max norm -ve                                /// 0032c
			 ...
			 0x80ffffff, // norm with min exp, max mant                   // SP - ve numbers                             /// 00340
			 ...
			 0x00000800,                                                  // SP - 1 bit alone set in mantissa +ve        /// 0037c
			 0xffc00000, // DefaultNan                                    // SP - ve numbers                             /// 00380
			 ...
			 0x7fc00001,                                                  // signaling NaN                               /// 00528
			 0xff800000, // infinity                                      // SP - ve numbers                             /// 0052c
			 ...
			 0x55555555,                                                  // 4 random values                             /// 00544
			 ...
			 0x007fffff, // max subnorm                                   // SP +ve numbers                              /// 0059c
			 ...
			 0x00000020,                                                  // SP - 1 bit alone set in mantissa +ve        /// 005f8
			 0x7fc00001, // QNan                                          // SP +ve numbers                              /// 005fc
			 0xff7ffffe, // max norm - 2ulp                               // max norm -ve                                /// 00600
			 ...
			 0x7fc00001,                                                  // signaling NaN                               /// 00658
			 ...
			 0x80080000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 006a0
			 ...
			 0x0c400000,                                                  // Leading 1s:                                 /// 00784
			 0x0e000001,                                                  // Trailing 1s:                                /// 00788
			 ...
			 0x0f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 007a4
			 ...
			 0x80ffffff, // norm with min exp, max mant                   // SP - ve numbers                             /// 008f8
			 ...
			 0xffc00001, // QNan                                          // SP - ve numbers                             /// 00934
			 ...
			 0x80000200,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00960
			 ...
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 009a8
			 ...
			 0x80800000, // min norm                                      // SP - ve numbers                             /// 009e0
			 0x00800000,                                                  // none of the mantissa set to +3ulp           /// 009e4
			 ...
			 0x7f000000, // norm with max exp, min mant                   // SP +ve numbers                              /// 00a20
			 ...
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00b54
			 ...
			 0x0e000007,                                                  // Trailing 1s:                                /// 00be0
			 0x00200000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00be4
			 0x0e3fffff,                                                  // Trailing 1s:                                /// 00be8
			 0x80020000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00bec
			 ...
			 0x00040000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00c14
			 ...
			 0x00000002, // min subnorm + 1 ulp                           // SP +ve numbers                              /// 00cd8
			 ...
			 0x80000008,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d04
			 ...
			 0x80000040,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d2c
			 0x00800003,                                                  // none of the mantissa set to +3ulp           /// 00d30
			 0x00000080,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00d34
			 0x00020000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00d38
			 0x80002000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d3c
			 0x0c7ffc00,                                                  // Leading 1s:                                 /// 00d40
			 0x0e000fff,                                                  // Trailing 1s:                                /// 00d44
			 0x7fc00001,                                                  // signaling NaN                               /// 00d48
			 ...
			 0x00000010,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00d5c
			 ...
			 0x8f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 00d88
			 ...
			 0x80020000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00de8
			 ...
			 0x7f800001, // SNaN                                          // SP +ve numbers                              /// 00e9c
			 ...
			 0x7f800000, // infinity                                      // SP +ve numbers                              /// 00ef8
			 0x00000001, // min subnorm                                   // SP +ve numbers                              /// 00efc
			 ...
			 0x0e0003ff,                                                  // Trailing 1s:                                /// 00f64
			 0x0c7fffc0,                                                  // Leading 1s:                                 /// 00f68
			 ...
			 0x80000040,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00f98
			 ...
			 0x80800003,                                                  // none of the mantissa set to +3ulp           /// 00fec
	...
	volatile uint32_t m_14[1024] __attribute__ ((aligned (4096))) = {
			 ...
			 0x00800002,                                                  // none of the mantissa set to +3ulp           /// 000d0
			 ...
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00108
			 ...
			 0xffc00001, // QNan                                          // SP - ve numbers                             /// 00128
			 ...
			 0x80011111,                                                  // -9.7958E-41                                 /// 00168
			 0x80000010,                                                  // SP - 1 bit alone set in mantissa -ve        /// 0016c
			 ...
			 0x7f7ffffe, // max norm - 2ulp                               // max norm +ve                                /// 00200
			 ...
			 0xbf800001, // 1  + 1ulp                                     // SP - ve numbers                             /// 00330
			 ...
			 0x0f7ffffd,                                                  // all bit of mantissa set upto -3ulp          /// 00348
			 ...
			 0x00800003,                                                  // none of the mantissa set to +3ulp           /// 0039c
			 0x80000080,                                                  // SP - 1 bit alone set in mantissa -ve        /// 003a0
			 0x7fbfffff, // SNaN                                          // SP +ve numbers                              /// 003a4
			 0x3f800001, // 1  + 1ulp                                     // SP +ve numbers                              /// 003a8
			 0x0c7f8000,                                                  // Leading 1s:                                 /// 003ac
			 0x807ffffe, // max subnorm - 1ulp                            // SP - ve numbers                             /// 003b0
			 0x0c7ffe00,                                                  // Leading 1s:                                 /// 003b4
			 ...
			 0x00000400,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00520
			 ...
			 0x80800003, // min norm + 3ulp                               // subnormals -ve                              /// 0055c
			 0x4b8c4b40,                                                  // 18388608.0                                  /// 00560
			 ...
			 0x80000400,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00574
			 0x0e1fffff,                                                  // Trailing 1s:                                /// 00578
			 0xff7fffff, // max norm                                      // max norm -ve                                /// 0057c
			 ...
			 0x80800001, // min norm + 1ulp                               // SP - ve numbers                             /// 00688
			 ...
			 0x00400000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00740
			 0x80800001, // min norm + 1ulp                               // SP - ve numbers                             /// 00744
			 0x0e000001,                                                  // Trailing 1s:                                /// 00748
			 ...
			 0x80800001, // min norm + 1ulp                               // subnormals -ve                              /// 0078c
			 ...
			 0x7f800000, // infinity                                      // SP +ve numbers                              /// 00800
			 ...
			 0x80000200,                                                  // SP - 1 bit alone set in mantissa -ve        /// 0085c
			 ...
			 0xff800000,                                                  // -inf                                        /// 00874
			 0x7f7ffffe, // max norm - 1ulp                               // SP +ve numbers                              /// 00878
			 0x0d000ff0,                                                  // Set of 1s                                   /// 0087c
			 0x00008000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00880
			 0x80040000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00884
			 0x0e00001f,                                                  // Trailing 1s:                                /// 00888
			 ...
			 0x00040000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 008dc
			 ...
			 0x00080000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00a08
			 ...
			 0x80000001,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00a34
			 0xff7fffff, // max norm                                      // max norm -ve                                /// 00a38
			 ...
			 0x7f7fffff, // max norm                                      // SP +ve numbers                              /// 00a64
			 ...
			 0x7f7ffffe, // max norm - 1ulp                               // SP +ve numbers                              /// 00acc
			 ...
			 0x00000002,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00aec
			 ...
			 0xff7fffff, // max norm                                      // max norm -ve                                /// 00b6c
			 ...
			 0xff7ffffe, // max norm - 2ulp                               // max norm -ve                                /// 00bd0
			 0x00008000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00bd4
			 0x80800003, // min norm + 3ulp                               // subnormals -ve                              /// 00bd8
			 0x00800002,                                                  // none of the mantissa set to +3ulp           /// 00bdc
			 0x0f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 00be0
			 0x7f7ffffe, // max norm - 3ulp                               // max norm +ve                                /// 00be4
			 0x0e00001f,                                                  // Trailing 1s:                                /// 00be8
			 0x00800001, // min norm + 1ulp                               // SP +ve numbers                              /// 00bec
			 ...
			 0x00000004,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00c08
			 0x80000001,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00c0c
			 ...
			 0x80010000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00c6c
			 ...
			 0x7f800000, // infinity                                      // SP +ve numbers                              /// 00c88
			 ...
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00cf4
			 0x0c7fffe0,                                                  // Leading 1s:                                 /// 00cf8
			 ...
			 0x00040000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00d08
			 ...
			 0x80004000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d70
			 0x80800000, // min norm                                      // SP - ve numbers                             /// 00d74
			 0x80000010,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00d78
			 ...
			 0x00000008,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00e84
			 0x80800000, // min norm                                      // SP - ve numbers                             /// 00e88
			 ...
			 0xffc00000, // DefaultNan                                    // SP - ve numbers                             /// 00f08
			 ...
			 0xbf800001, // 1  + 1ulp                                     // SP - ve numbers                             /// 00f3c
			 ...
			 0x0e3fffff,                                                  // Trailing 1s:                                /// 00fd0
			 0x807fffff, // max subnorm                                   // SP - ve numbers                             /// 00fd4
			 0x0c7f0000,                                                  // Leading 1s:                                 /// 00fd8
			 0x8f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00fdc
	...
	volatile uint32_t m_15[1024] __attribute__ ((aligned (4096))) = {
			 ...
			 0x00800001,                                                  // none of the mantissa set to +3ulp           /// 0010c
			 ...
			 0x00010000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 0012c
			 0xff7ffffe, // max norm - 1ulp                               // SP - ve numbers                             /// 00130
			 0x80200000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00134
			 0x0f7ffffe,                                                  // all bit of mantissa set upto -3ulp          /// 00138
			 ...
			 0x00000001, // min subnorm                                   // SP +ve numbers                              /// 001a0
			 ...
			 0x33333333,                                                  // 4 random values                             /// 001e8
			 ...
			 0x00001000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00214
			 ...
			 0x8f7ffffc,                                                  // all bit of mantissa set upto -3ulp          /// 00248
			 0xcb000000,                                                  // -8388608.0                                  /// 0024c
			 0x00001000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00250
			 0x007ffffe, // max subnorm - 1ulp                            // SP +ve numbers                              /// 00254
			 0xcb8c4b40,                                                  // -18388608.0                                 /// 00258
			 0x00800001, // min norm + 1ulp                               // SP +ve numbers                              /// 0025c
			 0x00800001, // min norm + 1ulp                               // SP +ve numbers                              /// 00260
			 ...
			 0x7f7ffffe, // max norm - 1ulp                               // SP +ve numbers                              /// 002a4
			 0x80011111,                                                  // -9.7958E-41                                 /// 002a8
			 0x3f028f5c,                                                  // 0.51                                        /// 002ac
			 ...
			 0x00000040,                                                  // SP - 1 bit alone set in mantissa +ve        /// 002f0
			 ...
			 0x00008000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00364
			 ...
			 0x00800002,                                                  // none of the mantissa set to +3ulp           /// 00394
			 ...
			 0x00000040,                                                  // SP - 1 bit alone set in mantissa +ve        /// 003bc
			 ...
			 0x3f800000, // 1                                             // SP +ve numbers                              /// 003e4
			 0x00001000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 003e8
			 0x80ffffff, // norm with min exp, max mant                   // SP - ve numbers                             /// 003ec
			 ...
			 0x00010000,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00400
			 0x80800001, // min norm + 1ulp                               // SP - ve numbers                             /// 00404
			 0x007fffff, // max subnorm                                   // SP +ve numbers                              /// 00408
			 ...
			 0xff7ffffe, // max norm - 2ulp                               // max norm -ve                                /// 00490
			 ...
			 0x7fffffff, // QNan                                          // SP +ve numbers                              /// 004dc
			 ...
			 0x00000010,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00548
			 ...
			 0x00800003,                                                  // none of the mantissa set to +3ulp           /// 005a0
			 ...
			 0xff7ffffe, // max norm - 2ulp                               // max norm -ve                                /// 005ec
			 ...
			 0x33333333,                                                  // 4 random values                             /// 00660
			 ...
			 0x80800001, // min norm + 1ulp                               // subnormals -ve                              /// 006f8
			 ...
			 0x7f000000, // norm with max exp, min mant                   // SP +ve numbers                              /// 007b0
			 0x80ffffff, // norm with min exp, max mant                   // SP - ve numbers                             /// 007b4
			 ...
			 0x00800003, // min norm + 3ulp                               // subnormals +ve                              /// 00874
			 ...
			 0x80800002,                                                  // none of the mantissa set to +3ulp           /// 008d0
			 ...
			 0x0c7fffc0,                                                  // Leading 1s:                                 /// 008e8
			 0x80010000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 008ec
			 0x0c7ff800,                                                  // Leading 1s:                                 /// 008f0
			 ...
			 0x80800000,                                                  // none of the mantissa set to +3ulp           /// 00958
			 ...
			 0x7f7ffffe, // max norm - 1ulp                               // SP +ve numbers                              /// 009ec
			 ...
			 0x7f7ffffe, // max norm - 3ulp                               // max norm +ve                                /// 00a18
			 ...
			 0x80000080,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00b40
			 ...
			 0x80020000,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00c84
			 ...
			 0x80800002,                                                  // none of the mantissa set to +3ulp           /// 00d64
			 ...
			 0x80000008,                                                  // SP - 1 bit alone set in mantissa -ve        /// 00e74
			 ...
			 0x00800003, // min norm + 3ulp                               // subnormals +ve                              /// 00eb8
			 ...
			 0x807ffffe, // max subnorm - 1ulp                            // SP - ve numbers                             /// 00f44
			 0x807ffffe, // max subnorm - 1ulp                            // SP - ve numbers                             /// 00f48
			 ...
			 0x7fc00001,                                                  // signaling NaN                               /// 00f58
			 ...
			 0x00000400,                                                  // SP - 1 bit alone set in mantissa +ve        /// 00f80
			 ...
			 0x7fc00001, // QNan                                          // SP +ve numbers                              /// 00fa8
			 ...
			 0xffbfffff, // SNaN                                          // SP - ve numbers                             /// 00fe8
			 0x80800003, // min norm + 3ulp                               // subnormals -ve                              /// 00fec
			 0xffc00000, // DefaultNan                                    // SP - ve numbers                             /// 00ff0
	...
	__asm__ __volatile__ (
		...
		"nop\n"
		"nop\n"
		"cubesgntc.ps f4, f5, f25\n"                          ///  1,    24
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"cubesgntc.ps f12, f24, f1\n"                         ///  1,    25
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		...
		"nop\n"
		"nop\n"
		"cubesgntc.ps f13, f15, f26\n"                        ///  1,    37
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"cubesgntc.ps f9, f18, f5\n"                          ///  1,    38
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		...
		"nop\n"
		"nop\n"
		"cubesgntc.ps f11, f4, f7\n"                          ///  1,    90
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
		"cubesgntc.ps f28, f9, f6\n"                          ///  1,    91
		"nop\n"
		"nop\n"
		"nop\n"
		"nop\n"
