...
int main()
{
   ...
   if( ((hart_id & 1) == 0 ) && (minion_id == 0)  ) {
      ...
      uint64_t my_addr = (1UL << 31) | (0 << 6) | (0 << 8);  // l2 bank 0, sub-bank 0 
      uint64_t compare;
      ...
      cache_line.valid = 1;
      cache_line.qw0_dw0 = 0xd;
      cache_line.qw0_dw1 = 0xe;
      cache_line.qw1_dw0 = 0xa;
      cache_line.qw1_dw1 = 0xd;
      cache_line.qw2_dw0 = 0xb;
      cache_line.qw2_dw1 = 0xe;
      cache_line.qw3_dw0 = 0xe;
      cache_line.qw3_dw1 = 0xf;
