...
int main()
{
   ...
   SC_OP_t write_b      = {sc_rand_write_global_byte,            "write_byte"};
   SC_OP_t read_b       = {sc_rand_read_global_and_check_byte,   "read_byte"};
   SC_OP_t write_w      = {sc_rand_write_global_word,            "write_word"};
   SC_OP_t read_w       = {sc_rand_read_global_and_check_word,   "read_word"};
   SC_OP_t atomic_w     = {sc_rand_atomic_global_and_check_word, "atomic_word"};
   //SC_OP_t read_qw      = {sc_rand_read_global_and_check_qw,     "read_qw"};
   //SC_OP_t write_around = {sc_rand_write_around,                 "write_around"};
   SC_OP_t flush_l2     = {sc_rand_flush_L2, "flush_l2"};
   SC_OP_t flush_l3     = {sc_rand_flush_L3, "flush_l3"};
   SC_OP_t evict_l2     = {sc_rand_evict_L2, "evict_l2"};
   SC_OP_t evict_l3     = {sc_rand_evict_L3, "evict_l3"};
   //SC_OP_t prefetch_l1  = {sc_rand_prefetch_L1, "prefetch_l1"};
   SC_OP_t prefetch_l2  = {sc_rand_prefetch_L2, "prefetch_l2"};
   SC_OP_t prefetch_l3  = {sc_rand_prefetch_L3, "prefetch_l3"};
   ...
   // odd harts
      ...
      ops_pool[nn++] = flush_l2;
      ops_pool[nn++] = flush_l3;
      ops_pool[nn++] = evict_l2;
      ops_pool[nn++] = evict_l3;
      //ops_pool[nn++] = prefetch_l1;
      ops_pool[nn++] = prefetch_l2;
      ops_pool[nn++] = prefetch_l3;
      ops_pool[nn++] = nop;
      ops_pool[nn++] = nop;
   }
