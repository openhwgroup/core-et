...
#define DRAM_LOW_OS_REGION_BASE_ADDR        0x8004000000 //taken from PMA Secure Mode 
#define DRAM_LOW_OS_REGION_SIZE               0xFC000000
#define DRAM_LOW_MEMORY_REGION_BASE_ADDR    0x8100000000
#define DRAM_LOW_MEMORY_REGION_28GB_SIZE     0x700000000 //0x3F00000000  Reduced to 28GB to fit entire 32GB range
#define DRAM_LOW_MEMORY_REGION_12GB_SIZE     0x300000000 //0x3F00000000  Reduced to 12GB to fit entire 16GB range
