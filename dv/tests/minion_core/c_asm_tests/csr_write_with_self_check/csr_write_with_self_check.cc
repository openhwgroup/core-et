...
int main()
{
    ...
    if (mepc_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (sepc_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (sepc_value != 0x800000000000) {
        C_TEST_FAIL;
    }
    csr_write(CSR_ADDR_SEPC, 0x0000AABBCCDDEEFF);   //write a valid sign extension value
    sepc_value = csr_read(CSR_ADDR_SEPC); //read after write
    if (sepc_value != 0x0000AABBCCDDEEFE) {
        // Last bit is 0
        C_TEST_FAIL;
    }
    ...
    if (stvec_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (stval_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (mtvec_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (mtval_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (satp_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (satp_value != 0x9000000000001234) {
        C_TEST_FAIL;
    }    
    ...
    satp_value = csr_read(CSR_ADDR_SATP);
    // if (satp_value != 0x0000000000001234) {
    //    C_TEST_FAIL;
    //}
    // -- MATP -- //
    ...
    if (matp_value != 0x800000000000000) {
        C_TEST_FAIL;
    }
    // --MATP ENDE
    ...
    if (sie_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (sip_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
    ...
    if (mip_value != CSR_RESET_VALUE_ZERO) {
        C_TEST_FAIL;
    }
