...
int main()
{
    ...
    for(unsigned long long exponent=1; exponent < (((unsigned long long)1 << 8)-1); ++exponent)
        for(unsigned long long fraction=0; fraction < ((unsigned long long)1 << 22); ++fraction){
