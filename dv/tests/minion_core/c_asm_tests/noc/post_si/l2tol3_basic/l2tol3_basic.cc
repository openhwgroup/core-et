...
#ifdef DEBUG
      et_printf_long("H%d TEST: Waiting for FCC credit\n", hart_id);
#endif
//#ifdef POSTSI_DEBUG
//         print_dbg("H%d TEST: Waiting for FCC credit\n", hart_id);
//#endif
      }
...
#ifdef DEBUG
      et_printf_long("H%d TEST: Received FCC credit\n", hart_id);
#endif
#ifdef POSTSI_DEBUG
      print_dbg("H%d TEST: Received FCC credit\n", hart_id);
#endif
