...
namespace Matchers {
    ...
    namespace Vector {
        ...
        struct EqualsMatcher : MatcherBase<std::vector<T>> {
            ...
            bool match(std::vector<T> const &v) const override {
                // This currently works if all elements can be compared using !=
...
namespace Generators {
    ...
    // Move this into its own location?
    namespace pf{
...
namespace Generators {
    ...
    class MapGenerator : public IGenerator<T> {
        // Provide static assert for mapping function, for friendly error message
...
#include <android/log.h>
    ...
    namespace Catch {
        void writeToDebugConsole( std::string const& text ) {
            // Need a version for Mac/ XCode and other IDEs
            Catch::cout() << text;
        }
    }
...
namespace Catch {
        ...
        totals( _totals )
    {
        ...
        if( assertionResult.hasMessage() ) {
            ...
            // This should have been done earlier, somewhere
    ...
    namespace {
        auto estimateClockResolution() -> uint64_t {
            ...
            for( std::size_t i = 0; i < iterations; ++i ) {
                ...
                // How to signal that the measured resolution is probably wrong?
...
namespace Catch {
    ...
    void JunitReporter::writeGroup( TestGroupNode const& groupNode, double suiteTime ) {
        ...
        xml.writeAttribute( "hostname", "unknown" );
