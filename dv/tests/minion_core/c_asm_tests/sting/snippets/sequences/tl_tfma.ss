...
unum_t  tl_csr_val = snp_seq_tload_wrapper()
unum_t  tl_x31_val = glbl_snp_get_tload_x31_wrapper(3)
...
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
;;;;; Tensor FMA
unum_t  tfma_csr_val = snp_seq_tfma_wrapper(tl_csr_val)
unum_t  ow_fregs = get_tfma_ow_unpr_fregs(tfma_csr_val)
...
if (SEQ_ENV.MIX == 0) :
   tl_tfma(pb_cpu_id = cpu_id, pb_rx1 = rx1, pb_tl_x31 = tl_x31, pb_tl_csr = tl_csr, pb_tfma_csr = tfma_csr)
else :
   mix_tl_tfma(pb_cpu_id = cpu_id, pb_rx1 = rx1, pb_tl_x31 = tl_x31, pb_tl_csr = tl_csr, pb_tfma_csr = tfma_csr)
endif
