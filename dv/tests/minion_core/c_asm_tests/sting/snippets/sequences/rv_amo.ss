...
if (require_fs1 || require_fs2 || require_fs3):
   ...
   ; OP0
   inline_comb_inst(pb_inst0_val = amo_op0_val, pb_inst1_val = rv_op0_val)
   ; OP1
   inline_comb_inst(pb_inst0_val = amo_op1_val, pb_inst1_val = rv_op1_val)
   ; OP2
   inline_comb_inst(pb_inst0_val = amo_op2_val, pb_inst1_val = rv_op2_val)
   ; OP3
   inline_comb_inst(pb_inst0_val = amo_op3_val, pb_inst1_val = rv_op3_val)
   ; OP4
   inline_comb_inst(pb_inst0_val = amo_op4_val, pb_inst1_val = rv_op4_val)
