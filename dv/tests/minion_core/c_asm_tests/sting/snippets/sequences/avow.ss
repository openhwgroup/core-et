...
unum_t mask_op5_val = get_seq_mask_ins(et_ins_conf_ptr)
...
unum_t pi_op5_val = get_seq_pi_ins(et_ins_conf_ptr)
...
unum_t rv_op5_val = get_seq_riscv_base_ins(et_ins_conf_ptr)
...
if (set_x31 == 1):
   ...
   avow_write_tensor_csr(avow_csr = tensor_op0_csr, avow_op_type = tensor_op0_type)
   ...
   avow_write_tensor_csr(avow_csr = tensor_op1_csr, avow_op_type = tensor_op1_type)
   ...
   avow_write_tensor_csr(avow_csr = tensor_op2_csr, avow_op_type = tensor_op2_type)
   ...
   avow_write_tensor_csr(avow_csr = tensor_op3_csr, avow_op_type = tensor_op3_type)
   ...
   avow_write_tensor_csr(avow_csr = tensor_op4_csr, avow_op_type = tensor_op4_type)

   avow_inline_ins(pb_ins0 = ps_op5_val, pb_ins1 = amo_op5_val, pb_ins2 = mask_op5_val, pb_ins3 = pi_op5_val, pb_ins4 = rv_op5_val)
   if (clean_tenb != 0):
