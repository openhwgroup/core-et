...
; Then, it does a random tensor_fma16, followed by randomizing r_gen_reduce
...
; It repeats the sequence of fma16, optional reduce, optional quant in a loop of 10
