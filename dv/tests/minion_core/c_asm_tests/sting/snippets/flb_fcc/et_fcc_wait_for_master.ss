...
; It chooses a master HART which will send credits to all other HARTs.
; while the others will try to consume that credit.
;
...
unum_t master_cpu = glbl_snp_get_fcc_master(per_shire_participants_mask)
