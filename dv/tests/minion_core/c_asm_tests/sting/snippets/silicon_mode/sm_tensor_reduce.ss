...
memory_t sm_post_vpurf[ET_TEST_ENV.NUM_MINIONS][1024]@64:ET_DRAM_REGION
memory_t sm_tr_info[ET_TEST_ENV.NUM_MINIONS][128]@64:ET_DRAM_REGION
...
if (is_reducing == 1):
   ...
   if ((cpu_id%2) == 0):
      ...
      sm_set_tr_info(regx1 = rx1, regx2 = rx2, et_info_addr = sm_tr_info[l_mid], csr_enc_reg = tr_csr, partnr_tr_info_addr = sm_tr_info[partner_l_mid], pre_vpurf_addr = sm_pre_vpurf[l_mid], post_vpurf_addr = sm_post_vpurf[l_mid], phy_mid = pmid)
   ...
   csr_return_is_0_x:
      ...
      dump_vpu_rf(_pb_rx1 = rx1, _pb_mem_addr = sm_post_vpurf[l_mid])
