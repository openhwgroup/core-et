...
memory_t sm_ts_info[128]@64:ET_DRAM_REGION
...
if ((cpu_id%2) == 0):
   ...
   sm_set_ts_info(regx1 = rx1, regx2 = rx2, et_info_addr = sm_ts_info, csr_enc_reg = ts_csr, x31_reg = ts_x31, pre_vpurf_addr = sm_pre_vpurf, post_data_addr = sm_post_data, phy_mid = pmid)
endif
...
if ((cpu_id%2) == 0):
   snippet_start(random_num = rand_start, rega = rx1, regb = rx2)
   selfcheck_tstore(et_info_addr = sm_ts_info)
endif
