...
memory_t sm_x_pre_vpurf[1024]@64:ET_DRAM_REGION
memory_t sm_x_post_vpurf[1024]@64:ET_DRAM_REGION
memory_t sm_x_tr_info[128]@64:ET_DRAM_REGION

memory_t sm_y_pre_vpurf[1024]@64:ET_DRAM_REGION
memory_t sm_y_post_vpurf[1024]@64:ET_DRAM_REGION
memory_t sm_y_tr_info[64]@64:ET_DRAM_REGION
...
if ((tid_y == 0) | (tid_x == tid_y)):
   ...
   if ((x%2) == 0):
      dump_vpu_rf(_pb_rx1 = rx1, _pb_mem_addr = sm_x_pre_vpurf)
      flush_vpu_rf(pb_rx1 = rx1, pb_rx2 = rx2, pb_mem_addr = sm_x_pre_vpurf)
      sm_set_tr_info(regx1 = rx1, regx2 = rx2, et_info_addr = sm_x_tr_info, csr_enc_reg = tr_csr, partnr_tr_info_addr = sm_y_tr_info, pre_vpurf_addr = sm_x_pre_vpurf, post_vpurf_addr = sm_x_post_vpurf, phy_mid = mid_x)
      flush_et_info(pb_rx1 = rx1, pb_rx2 = rx2, pb_mem_addr = sm_x_tr_info)
   endif
   ...
   if ((x%2) == 0):
      ...
      csr_return_is_0_x:
         ...
         dump_vpu_rf(_pb_rx1 = rx1, _pb_mem_addr = sm_x_post_vpurf)
...
if ((tid_x == 0) | (tid_x == tid_y)):
   ...
   if ((y%2) == 0):
      dump_vpu_rf(_pb_rx1 = rx1, _pb_mem_addr = sm_y_pre_vpurf)
      flush_vpu_rf(pb_rx1 = rx1, pb_rx2 = rx2, pb_mem_addr = sm_y_pre_vpurf)
      sm_set_tr_info(regx1 = rx1, regx2 = rx2, et_info_addr = sm_y_tr_info, csr_enc_reg = tr_csr, partnr_tr_info_addr = sm_x_tr_info, pre_vpurf_addr = sm_y_pre_vpurf, post_vpurf_addr = sm_y_post_vpurf, phy_mid = mid_y)
      flush_et_info(pb_rx1 = rx1, pb_rx2 = rx2, pb_mem_addr = sm_y_tr_info)
   endif
   ...
   if ((y%2) == 0):
      ...
      csr_return_is_0_y:
         ...
         dump_vpu_rf(_pb_rx1 = rx1, _pb_mem_addr = sm_y_post_vpurf)
...
if ((tid_y == 0) | (tid_x == tid_y)):
   if ((x%2) == 0):
      snippet_start(random_num = rand_init, rega = rx1, regb = rx2)
      selfcheck_tr(et_info_addr = sm_x_tr_info)
   endif
endif
...
if ((tid_x == 0) | (tid_x == tid_y)):
   if ((y%2) == 0):
      snippet_start(random_num = rand_init, rega = rx1, regb = rx2)
      selfcheck_tr(et_info_addr = sm_y_tr_info)
   endif
endif
