...
gmemory_t smg_post_l1scp[ET_TEST_ENV.NUM_MINIONS][3072]@64:ET_DRAM_REGION
...
if ((cpu_id%2) == 0):
   ...
   sm_set_tl_info(regx1 = rx1, regx2 = rx2, et_info_addr = selfcheck_info[cpuid], csr_enc_reg = tl_csr, x31_reg = tl_x31, pre_data_addr = smg_pre_l1scp[lmid], post_data_addr = smg_post_l1scp[lmid])
endif
...
if ((cpu_id%2) == 0):
   ...
   dump_l1scp(pb_rx1 = rx1, pb_rx2 = rx2, pb_rx3 = rx3, pb_mem_addr = smg_post_l1scp[lmid])
endif
...
if (ET_TEST_ENV.SCP_ENABLE == 1):
   if ((cpu_id%2) == 0):
      snippet_start(random_num = rand_start, rega = rx1, regb = rx2)
      selfcheck_tl(et_info_addr = selfcheck_info[cpuid])
   endif
endif
