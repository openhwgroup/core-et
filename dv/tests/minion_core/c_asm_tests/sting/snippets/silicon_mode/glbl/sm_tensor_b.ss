...
if ((cpuid%2) == 0):
   ...
   sm_set_tfma_info(regx1 = rx1, regx2 = rx2, et_info_addr = selfcheck_info[cpuid], csr_enc_reg = tfma_csr, x31_reg = tl_x31, pre_data_addr = smg_pre_l1scp[lmid], pre_vpurf_addr = smg_pre_vpurf[lmid], tl_tenb_csr_reg = tl_csr, post_data_addr = smg_post_vpurf[lmid], pre_tenc_addr = smg_pre_vputenc[lmid], post_tenc_addr = smg_post_vputenc[lmid], phy_mid = pmid)
endif
   ...
   seq_tfma(_cpu_id = cpuid, _rx1 = rx1, _tfma_csr = tfma_csr, _self_check = 1)
