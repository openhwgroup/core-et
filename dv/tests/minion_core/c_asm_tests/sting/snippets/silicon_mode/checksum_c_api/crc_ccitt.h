...
// Array for calculations of the CRC-CCITT
static uint16_t crc_ccitt_table[] = {   0x0, 0x1021, 0x2042, 0x3063, 0x4084, 0x50a5, 0x60c6, 0x70e7, 0x8108, 0x9129, 0xa14a, 0xb16b, 0xc18c, 0xd1ad, 0xe1ce, 0xf1ef, \
...
// The following commented code generates the table shown above
/*
#define POLY 0x1021
static void init_crc_ccitt_table() {
   for (int i = 0; i < 256; i++) {
