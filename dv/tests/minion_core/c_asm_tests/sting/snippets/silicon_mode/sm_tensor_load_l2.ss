...
memory_t sm_tl_l2_info[128]@64:ET_DRAM_REGION
...
if ((tl_l2scp_csr_val & 0x8000000000000000) != 0):
   ...
   sm_set_tl_l2_info(regx1 = rx1, regx2 = rx2, et_info_addr = sm_tl_l2_info, csr_enc_reg = csr_reg, x31_reg = x31)
   ...
   test_fail(regz = rx1)
csr_return_is_0:
   selfcheck_tl_l2(et_info_addr = sm_tl_l2_info)
