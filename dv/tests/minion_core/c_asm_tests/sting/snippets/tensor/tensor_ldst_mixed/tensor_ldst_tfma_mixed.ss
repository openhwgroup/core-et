...
unum_t  ts_x31_val = snp_get_ts_stride(ts_csr_val_base, ts_x31_rand)
...
unum_t tfma_fregs_mask = get_tfma_ow_unpr_fregs(tfma_scp_csr_val)
...
@cpu: cpu_x
    ...
    SELECT 1 {
        ...
        1 : tensor_fma_snip_run(csr_regx = csr_reg, regxa = rx1, regxb = rx2, rand_csr_val = tfma_scp_csr_val, ten_mask_val = tl_mask_val, ten_wait = ten_wait_en, backup_mem = mem_fp, hartid = cpuid)
    }
