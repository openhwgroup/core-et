...
memory_t  mem1[4544]@64:ET_MINION_SHIRE_MEM_SET
...
if (ET_TEST_ENV.STING_RAND == 1) :
   ...
   ten_wait_en = snp_urandrange(0,2)
    ...
    tensor_store_snip_run(num_ts_csr_val = ts_csr_val, num_x31_val = x31_val, memx = mem1, addr_off = 0, csr_regx = csr_reg, regx1 = rx1, regx2 = rx2, regx3 = rx3, is_coop = 0, ten_wait = ten_wait_en)
