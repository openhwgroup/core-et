...
if (TEST_PROPS.TEST_MODE == RV_PARAMS.RV_MODE.MACHINE):
   write_ESR_value(rega = rx1, regb = rx2, regc = rx3, shireid = 0, esr_addr = neigh_chicken_esr, esr_value = 1)
   write_ESR_value(rega = rx1, regb = rx2, regc = rx3, shireid = 1, esr_addr = neigh_chicken_esr, esr_value = 1)
