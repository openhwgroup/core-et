...
#define SC_NOC_PV_SC_M0_L2_SIZE 512*1024
#define SC_NOC_CACHE_LINES ((SC_NOC_PV_SC_M0_L2_SIZE/64)/64)*2
#define SC_NOC_ELEMS_CACHE 64/sizeof(uint64_t)

uint64_t sc_noc_pv_glbl_mem[2176][SC_NOC_CACHE_LINES][SC_NOC_ELEMS_CACHE] __attribute__ ((aligned (8192)));
