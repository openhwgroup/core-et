...
EXTERN_C void  __attribute__ ((interrupt ("supervisor"))) irq_handler();
EXTERN_C void  __attribute__ ((interrupt ("supervisor"))) bad_trap();
EXTERN_C void mtrap_vector();
inline unsigned int get_hart_id() __attribute__((always_inline));
inline unsigned int get_mhart_id() __attribute__((always_inline));
void test_t0();
void test_t1();
