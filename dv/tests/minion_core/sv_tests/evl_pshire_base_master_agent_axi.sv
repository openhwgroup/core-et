//--------------------------------------------------------------------------------------------------
//
// Class: evl_pshire_base_master_agent_axi
//
// This class is an extension of evl_stim_agent_axi to define a base agent for PCI shire master
// agents.
//
class evl_pshire_base_master_agent_axi extends evl_stim_agent_axi;

   `uvm_component_utils(evl_pshire_base_master_agent_axi)
   ...
   // Constructor
   //
   function new(input string           name_in       = "evl_pshire_base_master_agent_axi",
...
endclass : evl_pshire_base_master_agent_axi
