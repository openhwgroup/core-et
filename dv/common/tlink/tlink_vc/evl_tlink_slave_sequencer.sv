//--------------------------------------------------------------------------------------------------
//
// Class: evl_tlink_slave_sequencer
//
class evl_tlink_slave_sequencer extends evl_push_sequencer#(evl_req_desc);


   `uvm_component_utils(evl_tlink_slave_sequencer)
   ...
   // Constructor
   //
   function new(input string name_in = "evl_tlink_slave_sequencer", input uvm_component parent_in = null);
      super.new(name_in, parent_in);
   endfunction : new

endclass : evl_tlink_slave_sequencer
