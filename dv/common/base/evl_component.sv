...
// Class: evl_component
//
virtual class evl_component extends uvm_component;
   ...
   // Constructor
   //
   function new(input string name_in = "evl_component", input uvm_component parent_in = null);
      super.new(name_in, parent_in);
   endfunction : new

endclass : evl_component
