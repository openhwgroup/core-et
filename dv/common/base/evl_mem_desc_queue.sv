//--------------------------------------------------------------------------------------------------
//
// Class: evl_mem_desc_queue_base
//
class evl_mem_desc_queue_base extends evl_desc_queue#(evl_mem_desc);

   //-----------------------------------------------------------------------------------------------
   //
   // Constructor
   //
   function new(input string name_in = "evl_mem_desc_queue_base", input evl_desc_type_t desc_type_in = EVL_DESC_UNKNOWN);
      super.new(name_in, desc_type_in);
   endfunction : new

endclass : evl_mem_desc_queue_base


//--------------------------------------------------------------------------------------------------
//
// Class: evl_mem_desc_queue
//
class evl_mem_desc_queue extends evl_mem_desc_queue_base;
   ...
   // Constructor
   //
   function new(input string name_in = "evl_mem_desc_queue", input evl_desc_type_t desc_type_in = EVL_DESC_UNKNOWN);
      super.new(name_in, desc_type_in);
   endfunction : new

endclass : evl_mem_desc_queue
