...
`ifndef __EVL_MEMSHIRE_WEST_MESH_CVG
`define __EVL_MEMSHIRE_WEST_MESH_CVG

class memshire_west_mesh_cvg extends evl_void;

   covergroup memshire_west_mesh_parallel_flit_lyrs_in_cg with function sample (logic [7:0] flit_valid_in);

      option.name = "memshire_west_mesh_parallel_flit_lyrs_in_cg";
   ...
   covergroup memshire_west_mesh_parallel_flit_lyrs_out_cg with function sample (logic [7:0] flit_valid_out);

      option.name = "memshire_west_mesh_parallel_flit_lyrs_out_cg";
      option.per_instance         = 0;
      type_option.merge_instances = 1;
   ...
   covergroup memshire_west_mesh_axi_cg with function sample (bit atomic_rsp_req, atomic_rsp_rsp, atomic_rsp_req_rdy, atomic_rsp_rsp_rdy, mem_mesh_req, mem_mesh_rsp, mem_mesh_req_rdy, mem_mesh_rsp_rdy, 
                                                                  sbm_mesh_req, sbm_mesh_rsp, sbm_mesh_req_rdy, sbm_mesh_rsp_rdy);

      option.name = "memshire_west_mesh_axi_cg";
      option.per_instance         = 0;
      type_option.merge_instances = 1;
   ...
   function void sample_axi (bit atomic_rsp_awvalid, atomic_rsp_awready, atomic_rsp_wvalid, atomic_rsp_wready, atomic_rsp_bvalid, atomic_rsp_bready,
      ...
      memshire_west_mesh_axi_cg.sample(atomic_rsp_req, atomic_rsp_rsp, atomic_rsp_req_rdy, atomic_rsp_rsp_rdy, mem_mesh_req, mem_mesh_rsp, mem_mesh_req_rdy, mem_mesh_rsp_rdy, 
                                       sbm_mesh_req, sbm_mesh_rsp, sbm_mesh_req_rdy, sbm_mesh_rsp_rdy);
   ...
   function new();
      ...
      memshire_west_mesh_parallel_flit_lyrs_in_cg = new;
      memshire_west_mesh_parallel_flit_lyrs_out_cg = new;
      memshire_west_mesh_axi_cg = new;
