...
module cosim_txfma_rnd_adder_tb
#(
  ...
  input  logic                              cin,
  output logic [left_bit-1:right_bit]       orig_out,
  output logic [left_bit-1:right_bit]       new_out
);

  txfma_rnd_adder_orig #(
    .left_bit  (left_bit),
    .right_bit (right_bit),
...
endmodule : cosim_txfma_rnd_adder_tb
