...
module cosim_neigh_evict_ff_unit_tb
  import minion_pkg::*;
...
(
  ...
  output logic                               new_l2_dcache_req_ready_o,
  ...
  output logic                               new_dbg_sm_signals_o,

  output logic                               orig_l2_dcache_req_ready_o,
  ...
  output logic                               orig_dbg_sm_signals_o
);
  ...
  always_comb begin
    ...
    {new_evict_req_data3_o, new_evict_req_data2_o, new_evict_req_data1_o, new_evict_req_data0_o} =
        new_evict_req.data;
    ...
    {orig_evict_req_data3_o, orig_evict_req_data2_o, orig_evict_req_data1_o, orig_evict_req_data0_o} =
        orig_evict_req.data;
  ...
  neigh_evict_ff_unit_orig u_orig (
    .clock(clk_i),
    .reset(reset),
    .shire_id(shire_id_i),
    .neigh_id(neigh_id_i),
