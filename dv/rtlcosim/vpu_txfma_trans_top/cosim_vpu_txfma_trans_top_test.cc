...
#include "Vcosim_vpu_txfma_trans_top_tb.h"
...
using DUT = Vcosim_vpu_txfma_trans_top_tb;
...
int main(int argc, char** argv) {
    ...
    sim.check(sim.comparisons >= 500000, "real txfma/trans top cosim should generate at least 500000 comparisons");
