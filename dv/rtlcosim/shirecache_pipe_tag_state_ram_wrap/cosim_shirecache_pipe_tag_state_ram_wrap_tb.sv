...
//
// Co-simulation: original shire_cache_pipe_tag_state_ram_wrap vs
// shirecache_pipe_tag_state_ram_wrap (dual-port configuration).

`include "soc.vh"

module cosim_shirecache_pipe_tag_state_ram_wrap_tb
  import dft_pkg::*;
  import ram_cfg_pkg::*;
...
(
  ...
  input  logic                              rd_en_i,
  input  logic                              wr_en_i,
  input  logic [TagStateRamAddrSize-1:0]    rd_addr_i,
  input  logic [TagStateRamAddrSize-1:0]    wr_addr_i,
  input  logic [TagStateRamDataSize-1:0]    wr_data_i,
  ...
  output logic [TagStateRamDataSize-1:0]    orig_rd_data_o,
  output logic [TagStateRamDataSize-1:0]    new_rd_data_o
);
  ...
  shire_cache_pipe_tag_state_ram_wrap orig_tag_state_ram_wrap (
    .clock                   (clk_i),
    .reset                   (reset),
