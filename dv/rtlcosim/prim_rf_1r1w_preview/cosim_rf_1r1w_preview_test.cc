...
#include "Vcosim_rf_1r1w_preview_tb.h"
#include "cosim_ctrl.h"

#include <cstdint>
#include <string>

using DUT = Vcosim_rf_1r1w_preview_tb;
...
int main(int argc, char** argv) {
    ...
    step(1, 1, 0, 0, 0, 0x00, 0);
    step(0, 0, 1, 0, 0, 0x12, 0);
    step(1, 1, 0, 1, 1, 0x34, 1);
    step(0, 0, 1, 0, 3, 0x56, 1);
    step(1, 1, 0, 0, 0, 0x78, 1);
    step(0, 0, 1, 1, 3, 0x9a, 3);
    step(1, 1, 0, 1, 3, 0x9a, 3);
