...
static void fill_words_value(uint32_t *words, int nwords, uint32_t value) {
    for (int i = 0; i < nwords; ++i) words[i] = value;
}

template <typename SimT>
static void compare_words_masked(SimT &sim, const char *name,
...
template <typename SimT>
static void compare_scalar_masked(SimT &sim, const char *name,
                                  uint32_t orig, uint32_t newv,
                                  uint32_t mask) {
    sim.compare(name, orig & mask, newv & mask);
}
...
static void compare_all(SimT &sim) {
    ...
    compare_scalar_masked(sim, "l3_b", d->orig_to_axi_l3_b_bits_o, d->new_to_axi_l3_b_bits_o, 0x7ffu);
    ...
    compare_words_masked(sim, "l3_r", d->orig_to_axi_l3_r_bits_o, d->new_to_axi_l3_r_bits_o, 17, 0xfffu);
    ...
    compare_scalar_masked(sim, "sys_b", d->orig_to_axi_sys_b_bits_o, d->new_to_axi_sys_b_bits_o, 0x7ffu);
    ...
    compare_words_masked(sim, "sys_r", d->orig_to_axi_sys_r_bits_o, d->new_to_axi_sys_r_bits_o, 17, 0xfffu);
    ...
    compare_words_masked(sim, "sys_ar", d->orig_from_axi_sys_ar_bits_o, d->new_from_axi_sys_ar_bits_o, 3, 0x1fffffu);
    ...
    compare_words_masked(sim, "sys_uc_aw", d->orig_from_axi_sys_uc_aw_bits_o, d->new_from_axi_sys_uc_aw_bits_o, 3, 0x1ffffffu);
    compare_words_masked(sim, "sys_sbm_aw", d->orig_from_axi_sys_sbm_aw_bits_o, d->new_from_axi_sys_sbm_aw_bits_o, 3, 0x1ffffffu);
    ...
    compare_words_masked(sim, "sys_uc_w", d->orig_from_axi_sys_uc_w_bits_o, d->new_from_axi_sys_uc_w_bits_o, 10, 0x1u);
    compare_words_masked(sim, "sys_sbm_w", d->orig_from_axi_sys_sbm_w_bits_o, d->new_from_axi_sys_sbm_w_bits_o, 10, 0x1u);
}
...
int main(int argc, char **argv) {
    ...
    for (int i = 0; i < 4096; ++i) {
        ...
        d->to_axi_l3_b_lo_bits_i = exercise_payload_inputs ? 0x7ffu : 0u;
        fill_words_value(d->to_axi_l3_r_lo_bits_i, 17, payload_word);
        d->to_axi_sys_b_lo_bits_i = exercise_payload_inputs ? 0x7ffu : 0u;
        fill_words_value(d->to_axi_sys_r_lo_bits_i, 17, payload_word);
        fill_words_value(d->from_axi_sys_ar_lo_bits_i, 3, payload_word);
        fill_words_value(d->from_axi_sys_aw_lo_bits_i, 3, payload_word);
        fill_words_value(d->from_axi_sys_w_lo_bits_i, 10, payload_word);

        switch (i & 0x7f) {
            case 0x00: d->to_axi_l3_b_valid_lo_i = 1; break;
            case 0x08: d->to_axi_l3_r_valid_lo_i = 1; break;
            case 0x18: d->to_axi_sys_b_valid_lo_i = 1; break;
            case 0x20: d->to_axi_sys_r_valid_lo_i = 1; break;
            case 0x30: d->from_axi_sys_ar_valid_lo_i = 1; break;
            case 0x40: d->from_axi_sys_aw_valid_lo_i = 1; d->from_axi_sys_aw_vcvalid_lo_i = 1; break;
            case 0x48: d->from_axi_sys_aw_valid_lo_i = 1; d->from_axi_sys_aw_vcvalid_lo_i = 2; break;
            case 0x58: d->from_axi_sys_w_valid_lo_i = 1; d->from_axi_sys_w_vcvalid_lo_i = 1; break;
            case 0x60: d->from_axi_sys_w_valid_lo_i = 1; d->from_axi_sys_w_vcvalid_lo_i = 2; break;
            default: break;
        }
