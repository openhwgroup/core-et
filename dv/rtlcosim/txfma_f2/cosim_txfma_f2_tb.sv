...
(
  ...
  output logic [TXFMA_A3:TXFMA_B27] orig_fa_f3a_h,
  output logic [TXFMA_A3:TXFMA_B27] new_fa_f3a_h,
  output logic [TXFMA_A3:TXFMA_B27] orig_fc_f3a_h,
  output logic [TXFMA_A3:TXFMA_B27] new_fc_f3a_h,
  output logic [TXFMA_A3:TXFMA_B59] orig_prodsum_f3a_h,
  output logic [TXFMA_A3:TXFMA_B59] new_prodsum_f3a_h
);

  txfma_f2_orig u_orig (
    ...
    .fa_f3a_h (orig_fa_f3a_h),
    .fc_f3a_h (orig_fc_f3a_h),
    .prodsum_f3a_h (orig_prodsum_f3a_h)
  );
  ...
  txfma_f2 u_new (
    ...
    .padd_cin_f1a_h (padd_cin_f1a_h),
    .sel_famask_f1a_h (sel_famask_f1a_h),
    .fa_f3a_h (new_fa_f3a_h),
    .fc_f3a_h (new_fc_f3a_h),
    .prodsum_f3a_h (new_prodsum_f3a_h)
  );

endmodule : cosim_txfma_f2_tb
