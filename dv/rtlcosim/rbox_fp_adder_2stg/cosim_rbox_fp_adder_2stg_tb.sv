...
//
// Co-simulation wrapper: original rbox_fp_adder_2stg vs new rbox_fp_adder_2stg.
//
// The original is defined inside rbox_fp_adder_2stg.v alongside
// rbox_fp_fast_adder_shifter. We inline a renamed copy here to avoid
// module name collisions.

`include "soc.vh"

module cosim_rbox_fp_adder_2stg_tb (
  input  logic              clk_i,
  input  logic              rst_ni,
  ...
  rbox_fp_adder_2stg_orig u_orig (
    .clock (clk_i),
    .a     (orig_a),
    .b     (orig_b),
    .valid (valid_i),
