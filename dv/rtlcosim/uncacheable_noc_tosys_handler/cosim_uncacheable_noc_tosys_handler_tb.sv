...
module cosim_uncacheable_noc_tosys_handler_tb #(
  ...
  uncacheable_noc_tosys_handler_orig #(.REQQ_SIZE(ReqqSize)) u_orig (
  ...
  uncacheable_noc_tosys_handler #(.ReqqSize(ReqqSize)) u_new (
...
endmodule : cosim_uncacheable_noc_tosys_handler_tb
