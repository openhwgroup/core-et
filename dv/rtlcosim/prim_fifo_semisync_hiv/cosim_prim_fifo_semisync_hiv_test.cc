...
//
// Standalone RTL cosim for prim_fifo_semisync_hiv against vcfifo_wr_hiv_ss.

#include "Vcosim_prim_fifo_semisync_hiv_tb.h"
#include "cosim_ctrl.h"

#include <cstdint>
#include <cstdlib>

using DUT = Vcosim_prim_fifo_semisync_hiv_tb;
