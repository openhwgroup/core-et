...
//
// Co-simulation: original shire_cache_pipe_data_ram_wrap vs
// shirecache_pipe_data_ram_wrap.

`include "soc.vh"

module cosim_shirecache_pipe_data_ram_wrap_tb
  import dft_pkg::*;
  import ram_cfg_pkg::*;
...
(
  ...
  input  logic                            rd_en_i,
  input  logic                            wr_en_i,
  input  logic [DataRamAddrSize-1:0]      addr_i,
  input  logic [DataRamDataSize-1:0]      wr_data_i,
  input  logic [LineQwSize-1:0]           wr_qwen_i,
  ...
  output logic [DataRamDataSize-1:0]      orig_rd_data_o,
  output logic [DataRamDataSize-1:0]      new_rd_data_o
);
  ...
  shire_cache_pipe_data_ram_wrap orig_data_ram_wrap (
    .clock                   (clk_i),
    .reset                   (reset),
