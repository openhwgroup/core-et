...
(
  ...
  output logic [$bits(ptw_dbg_sm_t)-1:0] orig_dbg_sm_signals_o,
  ...
  output logic [$bits(ptw_dbg_sm_t)-1:0] new_dbg_sm_signals_o
);

  logic               reset;
  minion_ptw_req      new_req_data;
  ...
  ptw_dbg_sm_t        new_dbg_sm_signals;

  minion_ptw_req      orig_req_data;
  ...
  always_comb begin
    new_req_data = '0;
    new_req_data.satp_mode = req_satp_mode_i;
    new_req_data.satp_ppn  = req_satp_ppn_i;
    new_req_data.prv       = req_prv_i;
    ...
    orig_req_data = '0;
    orig_req_data.satp_mode = req_satp_mode_i;
    orig_req_data.satp_ppn  = req_satp_ppn_i;
    orig_req_data.prv       = req_prv_i;
    orig_req_data.addr      = req_addr_i;
