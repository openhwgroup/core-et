...
module cosim_shire_bus_master_tb (
  input  logic clk_i,
  input  logic rst_ni,
  ...
  input  logic [shire_sbm_pkg::SbmInterfaces-1:0] apb_pready_i,
  input  logic [shire_sbm_pkg::SbmInterfaces-1:0] apb_pslverr_i,
  ...
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] new_apb_psel_o,
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_psel_o,
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] new_apb_penable_o,
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_penable_o,
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] new_apb_pwrite_o,
  output logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_pwrite_o,
  output logic [16:0] new_apb_paddr_o [shire_sbm_pkg::SbmInterfaces],
  output logic [16:0] orig_apb_paddr_o [shire_sbm_pkg::SbmInterfaces],
  output logic [63:0] new_apb_pwdata_o [shire_sbm_pkg::SbmInterfaces],
  output logic [63:0] orig_apb_pwdata_o [shire_sbm_pkg::SbmInterfaces]
);
  ...
  shire_sbm_pkg::shire_apb_req_t [shire_sbm_pkg::SbmInterfaces-1:0] new_apb_req;
  shire_sbm_pkg::shire_apb_rsp_t [shire_sbm_pkg::SbmInterfaces-1:0] new_apb_rsp;
  ...
  logic [shire_sbm_pkg::SbmInterfaces-1:0][16:0] orig_apb_paddr;
  logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_penable;
  logic [shire_sbm_pkg::SbmInterfaces-1:0][63:0] orig_apb_prdata;
  logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_pready;
  logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_psel;
  logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_pslverr;
  logic [shire_sbm_pkg::SbmInterfaces-1:0][63:0] orig_apb_pwdata;
  logic [shire_sbm_pkg::SbmInterfaces-1:0] orig_apb_pwrite;
  ...
  always_comb begin
    ...
    for (int i = 0; i < shire_sbm_pkg::SbmInterfaces; i++) begin
      new_apb_rsp[i].pready = apb_pready_i[i];
      new_apb_rsp[i].pslverr = apb_pslverr_i[i];
      new_apb_rsp[i].prdata = apb_prdata_i;
      orig_apb_pready[i] = apb_pready_i[i];
      orig_apb_pslverr[i] = apb_pslverr_i[i];
      orig_apb_prdata[i] = apb_prdata_i;
      new_apb_psel_o[i] = new_apb_req[i].psel;
      new_apb_penable_o[i] = new_apb_req[i].penable;
      new_apb_pwrite_o[i] = new_apb_req[i].pwrite;
      new_apb_paddr_o[i] = new_apb_req[i].paddr[16:0];
      new_apb_pwdata_o[i] = new_apb_req[i].pwdata;
      orig_apb_psel_o[i] = orig_apb_psel[i];
      orig_apb_penable_o[i] = orig_apb_penable[i];
      orig_apb_pwrite_o[i] = orig_apb_pwrite[i];
      orig_apb_paddr_o[i] = orig_apb_paddr[i];
      orig_apb_pwdata_o[i] = orig_apb_pwdata[i];
    end
  end

  shire_bus_master u_new (
    .clk_i,
    .rst_ni,
    .rst_neigh_ni,
    .rst_shire_cache_ni,
    ...
    .credit_return_write_o (new_credit_return_write_o),
    .sys_axi_ar_i (new_ar),
  ...
  shire_bus_master_orig #(
    .sbm_interfaces (shire_sbm_pkg::SbmInterfaces),
    .max_conc_req   (shire_sbm_pkg::MaxConcReq),
    .sbm_apb_addr   (17),
    .sbm_apb_data   (64)
  ) u_orig (
    .clock (clk_i),
    ...
    .reset_shire_cache (~rst_shire_cache_ni),
    .reset_rbox (~rst_rbox_ni),
    .shire_virtual_id (shire_virtual_id_i),
    .enable_write (aw_valid_i),
    .enable_read (ar_valid_i),
    .credit_return_write (orig_credit_return_write_o),
    ...
    .apb_paddr (orig_apb_paddr),
    .apb_penable (orig_apb_penable),
    .apb_prdata (orig_apb_prdata),
    .apb_pready (orig_apb_pready),
    .apb_psel (orig_apb_psel),
    .apb_pslverr (orig_apb_pslverr),
    .apb_pwdata (orig_apb_pwdata),
    .apb_pwrite (orig_apb_pwrite)
  );
...
endmodule : cosim_shire_bus_master_tb
