...
#include "Vcosim_txfma_top_fake_tb.h"
...
using DUT = Vcosim_txfma_top_fake_tb;
...
int main(int argc, char** argv) {
    ...
    for (int cycle = 0; cycle < 2500; ++cycle) {
        ...
        const uint32_t r3 = xorshift32(rng);
    ...
    sim.check(sim.comparisons >= 15000,
              "txfma_top_fake cosim should generate at least 15000 comparisons");
