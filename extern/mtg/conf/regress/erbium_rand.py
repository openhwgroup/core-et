...
# Erbium Rand Configuration
# Components that work on Erbium
#
...
# Tensor operations (except TensorLoadL2SCP - no L2 Shire Cache)
main("RandomTensorWait",   5)
main("TensorLoad",        10)
main("TensorLoadCoop",    10)
# No TensorLoadL2SCP - no L2 Shire Cache on Erbium
main("TensorFMA",         10)
...
# FLB/FCC thread synchronization
